 ...
 *  night, and a "taken now" button under each dose. Gated on the block's own
 *  types, so every other block in the workspace renders exactly as it did
 ...
 *  — see `NightLine`'s doc comment.
 */
import {blockContentDecoratorsFacet, cachedContentDecorator, type BlockContentDecoratorContribution} from '@/extensions/blockInteraction.js'
import type {AppExtension} from '@/facets/facet.js'

import {DOSE_TYPE, NIGHT_TYPE} from '../../km/fields'
