import{useQuery as e}from"../../node_modules/@powersync/react/lib/hooks/watched/useQuery.js";import"../../node_modules/@powersync/react/lib/index.js";import{parsePropertiesMigration as t}from"../data/workspaceSchema.js";import{useHash as n}from"../../node_modules/react-use/esm/useHash.js";import{useRepo as r}from"../context/repo.js";import{parseAppHash as i}from"../utils/routing.js";import{c as a}from"react/compiler-runtime";var o=()=>{let e=a(3),t=r(),[o]=n(),s;return e[0]!==o||e[1]!==t.activeWorkspaceId?(s=t.activeWorkspaceId??i(o).workspaceId??null,e[0]=o,e[1]=t.activeWorkspaceId,e[2]=s):s=e[2],s},s=`
