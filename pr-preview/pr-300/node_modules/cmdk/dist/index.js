"use client";
import { composeRefs } from "../../@radix-ui/react-compose-refs/dist/index.js";
import { useId as useId$1 } from "../../@radix-ui/react-id/dist/index.js";
import { W } from "./chunk-NZJY6EH4.js";
import { Content, Overlay, Portal, Root } from "../node_modules/@radix-ui/react-dialog/dist/index.js";
import { Primitive } from "../node_modules/@radix-ui/react-primitive/dist/index.js";
import * as t from "react";
//#region node_modules/cmdk/dist/index.mjs
var N = "[cmdk-group=\"\"]", Y = "[cmdk-group-items=\"\"]", be = "[cmdk-group-heading=\"\"]", le = "[cmdk-item=\"\"]", ce = `${le}:not([aria-disabled="true"])`, Z = "cmdk-item-select", T = "data-value", Re = (r, o, n) => W(r, o, n), ue = t.createContext(void 0), K = () => t.useContext(ue), de = t.createContext(void 0), ee = () => t.useContext(de), fe = t.createContext(void 0), me = t.forwardRef((r, o) => {
	let n = L(() => {
		var e, a;
		return {
			search: "",
	...
	}), u = L(() => /* @__PURE__ */ new Set()), c = L(() => /* @__PURE__ */ new Map()), d = L(() => /* @__PURE__ */ new Map()), f = L(() => /* @__PURE__ */ new Set()), p = pe(r), { label: b, children: m, value: R, onValueChange: x, filter: C, shouldFilter: S, loop: A, disablePointerSelection: ge = !1, vimBindings: j = !0, ...O } = r, $ = useId$1(), q = useId$1(), _ = useId$1(), I = t.useRef(null), v = ke();
	k(() => {
		if (R !== void 0) {
			let e = R.trim();
	...
	return t.createElement(Primitive.div, {
		ref: o,
		tabIndex: -1,
		...O,
		"cmdk-root": "",
		...
		id: U.labelId,
		style: Te
	}, b), B(r, (e) => t.createElement(de.Provider, { value: E }, t.createElement(ue.Provider, { value: U }, e))));
}), he = t.forwardRef((r, o) => {
	var _, I;
	let n = useId$1(), u = t.useRef(null), c = t.useContext(fe), d = K(), f = pe(r), p = (I = (_ = f.current) == null ? void 0 : _.forceMount) != null ? I : c == null ? void 0 : c.forceMount;
	k(() => {
	...
	let { heading: n, children: u, forceMount: c, ...d } = r, f = useId$1(), p = t.useRef(null), b = t.useRef(null), m = useId$1(), R = K(), x = P((S) => c || R.filter() === !1 ? !0 : S.search ? S.filtered.groups.has(f) : !0);
	k(() => R.group(f), []), ve(f, p, [
		r.value,
		r.heading,
		b
	...
	return t.createElement(Primitive.div, {
		...
		"aria-hidden": !0,
		id: m
	}, n), B(r, (S) => t.createElement("div", {
		"cmdk-group-items": "",
		role: "group",
		"aria-labelledby": n ? m : void 0
	}, t.createElement(fe.Provider, { value: C }, S))));
}), ye = t.forwardRef((r, o) => {
	let { alwaysRender: n, ...u } = r, c = t.useRef(null), d = P((f) => !f.search);
	return !n && !d ? null : t.createElement(Primitive.div, {
		ref: composeRefs(c, o),
		...u,
		"cmdk-separator": "",
		role: "separator"
	...
	}, [r.value]), t.createElement(Primitive.input, {
		ref: o,
		...u,
		"cmdk-input": "",
		autoComplete: "off",
	...
	let { children: n, label: u = "Suggestions", ...c } = r, d = t.useRef(null), f = t.useRef(null), p = P((m) => m.selectedItemId), b = K();
	return t.useEffect(() => {
		...
		"aria-label": u,
		id: b.listId
	}, B(r, (m) => t.createElement("div", {
		ref: composeRefs(f, b.listInnerRef),
		"cmdk-list-sizer": ""
	}, m)));
}), xe = t.forwardRef((r, o) => {
	let { open: n, onOpenChange: u, overlayClassName: c, contentClassName: d, container: f, ...p } = r;
	return t.createElement(Root, {
		open: n,
		onOpenChange: u
	}, t.createElement(Portal, { container: f }, t.createElement(Overlay, {
		"cmdk-overlay": "",
		className: c
	}), t.createElement(Content, {
		"aria-label": r.label,
		"cmdk-dialog": "",
		className: d
	}, t.createElement(me, {
...
}), Ie = t.forwardRef((r, o) => P((u) => u.filtered.count === 0) ? t.createElement(Primitive.div, {
	ref: o,
	...r,
	"cmdk-empty": "",
	role: "presentation"
}) : null), Pe = t.forwardRef((r, o) => {
	...
	return t.createElement(Primitive.div, {
		...
		"aria-valuemax": 100,
		"aria-label": c
	}, B(r, (f) => t.createElement("div", { "aria-hidden": !0 }, f)));
}), _e = Object.assign(me, {
	List: Ce,
	Item: he,
	Input: Se,
...
var k = typeof window == "undefined" ? t.useEffect : t.useLayoutEffect;
function L(r) {
	let o = t.useRef();
