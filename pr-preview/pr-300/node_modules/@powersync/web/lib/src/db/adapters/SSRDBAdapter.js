import { BaseObserver, Mutex, timeoutSignal } from "../../../../../common/dist/bundle.js";
//#region node_modules/@powersync/web/lib/src/db/adapters/SSRDBAdapter.js
var MOCK_QUERY_RESPONSE = { rowsAffected: 0 };
/**
...
*/
var SSRDBAdapter = class extends BaseObserver {
	name;
	readMutex;
	writeMutex;
	constructor() {
