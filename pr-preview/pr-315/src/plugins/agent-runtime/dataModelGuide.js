//#region src/plugins/agent-runtime/dataModelGuide.ts
...
var DATA_MODEL_GUIDE = `# Knowledge Medium — data model (for agents)
...
`;
//#endregion
export { DATA_MODEL_GUIDE };

//# sourceMappingURL=dataModelGuide.js.map