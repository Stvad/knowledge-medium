...
import { MediaTracksMixin } from "../../media-tracks/dist/mixin.js";
import "../../media-tracks/dist/index.js";
...
var DashVideoElement = class extends MediaTracksMixin(CustomVideoElement) {
	...
	async load() {
		...
		this.#apiInit = true;
		const Dash = await __vitePreload(() => import("../../dashjs/dist/modern/esm/dash.all.min.js"), []);
...
//#endregion
export { dash_video_element_default };
