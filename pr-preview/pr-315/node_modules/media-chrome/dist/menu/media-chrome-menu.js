...
import { closestComposedNode, containsComposedNode, getActiveElement, getAttributeMediaController, getDocumentOrShadowRoot, getMediaController, insertCSSRule, namedNodeMapToObject } from "../utils/element-utils.js";
...
var MediaChromeMenu = class extends GlobalThis.HTMLElement {
	...
	connectedCallback() {
		...
		(_b = (_a = __privateGet(this, _mediaController)) == null ? void 0 : _a.associateElement) == null || _b.call(_a, this);
		if (!this.hidden) {
	...
	disconnectedCallback() {
		...
		this.disable();
		(_b = (_a = __privateGet(this, _mediaController)) == null ? void 0 : _a.unassociateElement) == null || _b.call(_a, this);
	...
	attributeChangedCallback(attrName, oldValue, newValue) {
		...
		if (attrName === Attributes.HIDDEN && newValue !== oldValue) {
			...
			if (this.hidden) __privateMethod(this, _handleClosed, handleClosed_fn).call(this);
			else __privateMethod(this, _handleOpen, handleOpen_fn).call(this);
			...
			if (newValue && this.isConnected) {
				__privateSet(this, _mediaController, getAttributeMediaController(this));
				(_d = (_c = __privateGet(this, _mediaController)) == null ? void 0 : _c.associateElement) == null || _d.call(_c, this);
			}
		} else if (attrName === Attributes.DISABLED && newValue !== oldValue) if (newValue == null) this.enable();
		else this.disable();
		else if (attrName === Attributes.STYLE && newValue !== oldValue) __privateMethod(this, _updateLayoutStyle, updateLayoutStyle_fn).call(this);
	}
	...
	*/
	...
	handleSelect(event) {
		...
		if (__privateGet(this, _invokerElement) && !this.hidden) {
			(_a = __privateGet(this, _previouslyFocused)) == null || _a.focus();
			this.hidden = true;
		}
	}
	get keysUsed() {
...
handleSlotChange_fn = function(event) {
	...
	if (["header", "title"].includes(slot.name)) __privateMethod(this, _toggleHeader, toggleHeader_fn).call(this);
	if (!slot.name) __privateGet(this, _handleMenuItems).call(this);
};
...
handleOpen_fn = function() {
	var _a;
	(_a = __privateGet(this, _invokerElement)) == null || _a.setAttribute("aria-expanded", "true");
...
handleClosed_fn = function() {
	var _a;
	(_a = __privateGet(this, _invokerElement)) == null || _a.setAttribute("aria-expanded", "false");
	unobserveResize(getBoundsElement(this), __privateGet(this, _handleBoundsResize));
	unobserveResize(this, __privateGet(this, _handleMenuResize));
};
...
handleFocusOut_fn = function(event) {
	...
	if (!containsComposedNode(this, event.relatedTarget)) {
		if (__privateGet(this, _isPopover)) (_a = __privateGet(this, _previouslyFocused)) == null || _a.focus();
		if (__privateGet(this, _invokerElement) && __privateGet(this, _invokerElement) !== event.relatedTarget && !this.hidden) this.hidden = true;
	}
};
...
handleKeyDown_fn = function(event) {
	...
	if (key === "Tab") {
		...
		(_e = __privateGet(this, _previouslyFocused)) == null || _e.focus();
		if (__privateGet(this, _isPopover)) this.hidden = true;
...
//#endregion
export { MediaChromeMenu, createIndicator, createMenuItem };

//# sourceMappingURL=media-chrome-menu.js.map