...
var AttributeTokenList = class {
	...
	add(...tokens) {
		...
		if (this.value === "" && !((_a = __privateGet(this, _el)) == null ? void 0 : _a.hasAttribute(`${__privateGet(this, _attr)}`))) return;
		(_b = __privateGet(this, _el)) == null || _b.setAttribute(`${__privateGet(this, _attr)}`, `${this.value}`);
	}
	remove(...tokens) {
		var _a;
		tokens.forEach((t) => __privateGet(this, _tokenSet).delete(t));
		(_a = __privateGet(this, _el)) == null || _a.setAttribute(`${__privateGet(this, _attr)}`, `${this.value}`);
	}
	contains(token) {
...
//#endregion
export { AttributeTokenList };

//# sourceMappingURL=attribute-token-list.js.map