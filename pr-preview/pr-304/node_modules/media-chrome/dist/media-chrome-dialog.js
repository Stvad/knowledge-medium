...
import { containsComposedNode, getActiveElement, getBooleanAttr, getOrInsertCSSRule, namedNodeMapToObject, setBooleanAttr } from "./utils/element-utils.js";
...
var MediaChromeDialog = class extends GlobalThis.HTMLElement {
	...
	attributeChangedCallback(attrName, oldValue, newValue) {
		__privateMethod(this, _init, init_fn).call(this);
		if (attrName === Attributes.OPEN && newValue !== oldValue) if (this.open) __privateMethod(this, _handleOpen, handleOpen_fn).call(this);
		else __privateMethod(this, _handleClosed, handleClosed_fn).call(this);
	}
	focus() {
...
handleFocusOut_fn = function(event) {
	...
	if (!containsComposedNode(this, event.relatedTarget)) {
		...
		if (__privateGet(this, _invokerElement) && __privateGet(this, _invokerElement) !== event.relatedTarget && this.open) this.open = false;
	}
};
...
//# sourceMappingURL=media-chrome-dialog.js.map