...
//#region src/plugins/backlinks/inline-counts/applies.ts
...
*  explicit guard. */
var inlineBacklinksApplies = (ctx) => !isFocalRender(ctx) && !ctx.blockContext?.isNestedSurface;
//#endregion
export { inlineBacklinksApplies };
