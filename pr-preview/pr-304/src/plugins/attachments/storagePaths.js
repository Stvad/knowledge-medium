//#region src/plugins/attachments/storagePaths.ts
/**
...
var attachmentObjectPath = (workspaceId, contentKey) => `${workspaceId}/${contentKey}`;
/**
...
*/
var authenticatedObjectUrl = (baseUrl, bucket, path) => {
	return `${baseUrl.replace(/\/$/, "")}/storage/v1/object/${bucket}/${path.split("/").map(encodeURIComponent).join("/")}`;
};
//#endregion
export { attachmentObjectPath, authenticatedObjectUrl };
