...
`,W=e=>e,G={parse:e=>e},Te={parse:e=>e},Ee={parse:e=>e},De={parse:e=>e},Oe=e({name:`core.subtree`,argsSchema:a({id:s(),hidePropertyChildren:r().optional()}),resultSchema:{parse:e=>e},resolve:async({id:e,hidePropertyChildren:t=!1},n)=>{n.depend({kind:`row`,id:e}),n.depend({kind:`parent-edge`,parentId:e});let r=t?await n.db.getAll(ce,[e,...K(n.repo)]):await n.db.getAll(oe,[e]),i=n.hydrateBlocks(W(r)).map((e,t)=>({...e,depth:r[t].depth}));for(let e of i)n.depend({kind:`parent-edge`,parentId:e.id});return i}}),ke=e({name:`core.ancestors`,argsSchema:a({id:s()}),resultSchema:G,resolve:async({id:e},t)=>{t.depend({kind:`row`,id:e});let n=await t.db.getAll(re,[e,e]);return t.hydrateBlocks(W(n))}}),Ae=e({name:`core.manyAncestors`,argsSchema:a({ids:n(s()).readonly()}),resultSchema:{parse:e=>e},resolve:async({ids:e},t)=>{if(e.length===0)return[];for(let n of e)t.depend({kind:`row`,id:n});let n=await t.db.getAll(g(e.length),[...e]),r=new Map;for(let t of e)r.set(t,[]);for(let e of n){let t=r.get(e.chain_start_id);t&&t.push(e)}return e.map(e=>({startId:e,ancestors:t.hydrateBlocks(W(r.get(e)??[]))}))}}),je=new WeakMap,K=e=>{let t=e.propertyDefinitions;if(!t)return[`[]`,``];let n=je.get(t);if(n)return n;let r=[];for(let e of t.seedsByKey.keys())r.push(te(t.workspaceId,e));let i=[JSON.stringify(r),t.workspaceId];return je.set(t,i),i},Me=e({name:`core.children`,argsSchema:a({id:s(),hidePropertyChildren:r().optional()}),resultSchema:G,resolve:async({id:e,hidePropertyChildren:t=!1},n)=>{n.depend({kind:`parent-edge`,parentId:e});let r=t?await n.db.getAll(h,[e,...K(n.repo)]):await n.db.getAll(ae,[e]);return n.hydrateBlocks(W(r))}}),Ne=e({name:`core.childIds`,argsSchema:a({id:s(),hydrate:r().optional(),hidePropertyChildren:r().optional()}),resultSchema:n(s()),resolve:async({id:e,hydrate:t=!1,hidePropertyChildren:n=!1},r)=>{if(r.depend({kind:`parent-edge`,parentId:e}),!t)return(n?await r.db.getAll(se,[e,...K(r.repo)]):await r.db.getAll(ie,[e])).map(e=>e.id);let i=n?await r.db.getAll(h,[e,...K(r.repo)]):await r.db.getAll(ae,[e]);return r.hydrateBlocks(W(i),{declareRowDeps:!1}).map(e=>e.id)}}),Pe=e({name:`core.byType`,argsSchema:a({workspaceId:s(),type:s()}),resultSchema:G,resolve:async({workspaceId:e,type:t},n)=>{if(!e)return[];n.depend({kind:`plugin`,channel:he,key:D(e,t)});let r=await n.db.getAll(O,[e,t]);return n.hydrateBlocks(W(r))}}),q=a({workspaceId:s(),types:n(s()).optional(),where:o(s(),c()).optional(),referencedBy:u.optional(),match:n(l).optional(),exclude:n(l).optional(),order:t([`created-asc`,`created-desc`]).optional()}),Fe=`a`,Ie=`t`,Le=(e,t)=>`
  ...
  SELECT DISTINCT '${Fe}' AS dep_kind, anc_id AS dep_id FROM walk${t===0?``:`
  UNION
  SELECT DISTINCT '${Ie}', r.target_id
  FROM walk
  JOIN block_references r
    ON r.source_id = walk.anc_id
   AND r.source_field IN (${Array.from({length:t},()=>`?`).join(`, `)})`}
`,J=(e,t,n,r)=>{if(e!==void 0)for(let[i,a]of Object.entries(e)){if(n.depend({kind:`plugin`,channel:fe,key:ge(t,i)}),typeof a!=`object`||!a||a instanceof Date||Array.isArray(a))continue;let e=Object.entries(a);if(e.length!==1)continue;let[o,s]=e[0];if(o!==`target`||typeof s!=`object`||!s||Array.isArray(s))continue;let c=s;Object.values(c).some(v)||(r?r.add(i):n.depend({kind:`plugin`,channel:de,key:T(t)})),J(c,t,n,null)}},Re=(e,t,n,r={})=>{if(e.sourceField!==void 0){n.depend({kind:`plugin`,channel:me,key:_e(t,e.id,e.sourceField)});return}n.depend({kind:`plugin`,channel:pe,key:ve(t,e.id)}),r.includeImplicitAncestorStructure&&n.depend({kind:`plugin`,channel:S,key:E(t,e.id)})},ze=(e,t,n,r)=>{for(let i of e)J(i.where,t,n,i.scope===`ancestor`?r:null),i.referencedBy!==void 0&&Re(i.referencedBy,t,n,{includeImplicitAncestorStructure:i.scope===`ancestor`})},Y=(e,t)=>{let n=e.workspaceId,r=e.types??[],i=e.referencedBy,a=e.match??[],o=e.exclude??[];for(let e of r)t.depend({kind:`plugin`,channel:he,key:D(n,e)});let s=new Set;J(e.where,n,t,null),i!==void 0&&Re(i,n,t),ze(a,n,t,s),ze(o,n,t,s);let c=Object.values(e.where??{}).some(v),l=a.some(e=>e.referencedBy!==void 0||e.where!==void 0&&Object.values(e.where).some(v));return r.length>0||i!==void 0||c||l||t.depend({kind:`plugin`,channel:de,key:T(n)}),{workspaceId:n,types:r,referencedBy:i,matchPredicates:a,excludePredicates:o,ancestorTargetProps:s}},X=(e,t)=>e.some(e=>e.scope===`ancestor`)||t.some(e=>e.scope===`ancestor`),Z=async(e,t,n,r)=>{le(e);let i=[...r],a=ue(e,t.repo.propertySchemas),o=await t.db.getAll(Le(a.sql,i.length),[...a.params,...i]);for(let r of o){if(r.dep_kind===Ie){t.depend({kind:`plugin`,channel:S,key:E(e.workspaceId,r.dep_id)});continue}n===`row`?t.depend({kind:`row`,id:r.dep_id}):t.depend({kind:`plugin`,channel:S,key:E(e.workspaceId,r.dep_id)})}},Be=async(e,t)=>{if(!e.workspaceId)return[];let n=y(e),{workspaceId:r,types:i,referencedBy:a,matchPredicates:o,excludePredicates:s,ancestorTargetProps:c}=Y(n,t);if(X(o,s)&&await Z(n,t,`row`,c),i.length===1&&n.where===void 0&&a===void 0&&o.length===0&&s.length===0&&n.order!==`created-desc`){let e=await t.db.getAll(O,[r,i[0]]);return t.hydrateBlocks(W(e))}let l=_(n,t.repo.propertySchemas),u=await t.db.getAll(l.sql,[...l.params]);return t.hydrateBlocks(W(u))},Ve=async(e,t)=>{if(!e.workspaceId)return[];let n=y(e),{matchPredicates:r,excludePredicates:i,ancestorTargetProps:a}=Y(n,t);X(r,i)&&await Z(n,t,`structure`,a);let o=_(n,t.repo.propertySchemas,{projection:`ids`});return(await t.db.getAll(o.sql,[...o.params])).map(e=>e.id)},He=e({name:`core.typedBlocks`,argsSchema:q,resultSchema:G,resolve:(e,t)=>Be(e,t)}),Ue=e({name:`core.typedBlockIds`,argsSchema:q,resultSchema:Te,resolve:(e,t)=>Ve(e,t)}),We=async(e,t)=>{if(!e.workspaceId)return 0;let n=y(e),{matchPredicates:r,excludePredicates:i,ancestorTargetProps:a}=Y(n,t);X(r,i)&&await Z(n,t,`structure`,a);let o=_(n,t.repo.propertySchemas,{projection:`count`});return(await t.db.get(o.sql,[...o.params]))?.count??0},Ge=e({name:`core.typedBlockCount`,argsSchema:q,resultSchema:Ee,resolve:(e,t)=>We(e,t)}),Ke=e({name:`core.searchByContent`,argsSchema:a({workspaceId:s(),query:s(),limit:i().optional()}),resultSchema:G,resolve:async({workspaceId:e,query:t,limit:n=50},r)=>{let i=N(t);if(i===null)return[];r.depend({kind:`plugin`,channel:x,key:w(e)});let a=await r.db.getAll(F,[e,i.matchQuery,i.rankQuery,P(i.rankQuery),n]);return r.hydrateBlocks(W(a),{declareRowDeps:!1})}}),qe=async(e,t)=>(await e.db.getAll(L,[t,f])).flatMap(e=>p(e.id)),Je=e({name:`core.recentBlocks`,argsSchema:a({workspaceId:s(),limit:i().optional()}),resultSchema:G,resolve:async({workspaceId:e,limit:t=50},n)=>{if(!e)return[];n.depend({kind:`plugin`,channel:x,key:w(e)});let r=await n.db.getAll(I,[e,t]);return n.hydrateBlocks(W(r),{declareRowDeps:!1})}}),Ye=e({name:`core.recentActivity`,argsSchema:a({workspaceId:s(),limit:i().optional()}),resultSchema:{parse:e=>e},resolve:async({workspaceId:e,limit:t=50},n)=>{if(!e)return[];n.depend({kind:`plugin`,channel:x,key:w(e)});let r=await n.db.getAll(R,z(await qe(n,e),e,t)),i=n.hydrateBlocks(W(r),{declareRowDeps:!1});if(i.length===0)return[];let a=await n.db.getAll(g(i.length),i.map(e=>e.id)),o=new Map;for(let e of i)o.set(e.id,[]);for(let e of a)o.get(e.chain_start_id)?.push(e);return i.map(t=>{let r=n.hydrateBlocks(W(o.get(t.id)??[]),{declareRowDeps:!1});for(let i of[t,...r])n.depend({kind:`plugin`,channel:S,key:E(e,i.id)});return{block:t,ancestors:r}})}}),Q=e({name:`core.firstChildByContent`,argsSchema:a({parentId:s(),content:s()}),resultSchema:De,resolve:async({parentId:e,content:t},n)=>{n.depend({kind:`parent-edge`,parentId:e});let r=await n.db.getAll(ie,[e]);for(let e of r)n.depend({kind:`row`,id:e.id});let i=await n.db.getOptional(we,[e,t]);return i===null?null:n.hydrateBlocks(W([i]),{declareRowDeps:!1})[0]??null}}),Xe=e({name:`core.aliasesInWorkspace`,argsSchema:a({workspaceId:s(),filter:s().optional()}),resultSchema:n(s()),resolve:async({workspaceId:e,filter:t=``},n)=>{if(!e)return[];n.depend({kind:`plugin`,channel:b,key:C(e)});let r=P(t);return(await n.db.getAll(B,[e,t,r,t,r])).map(e=>e.alias)}}),Ze=e({name:`core.aliasMatches`,argsSchema:a({workspaceId:s(),filter:s(),limit:i().optional()}),resultSchema:n(a({alias:s(),blockId:s(),content:s()})),resolve:async({workspaceId:e,filter:t,limit:n=50},r)=>{if(!e)return[];r.depend({kind:`plugin`,channel:b,key:C(e)});let i=P(t),a=await r.db.getAll(Ce,[e,t,i,t,i,n]);for(let e of a)r.depend({kind:`row`,id:e.blockId});return a}}),Qe=e({name:`core.aliasMatchesFuzzy`,argsSchema:a({workspaceId:s(),prefixes:n(s()),query:s().optional(),limit:i().optional()}),resultSchema:n(a({alias:s(),blockId:s(),content:s(),updatedAt:i()})),resolve:async({workspaceId:e,prefixes:t,query:n=``,limit:r=100},i)=>{if(!e)return[];i.depend({kind:`plugin`,channel:b,key:C(e)});let a=U(t.length),o=n.toLowerCase(),s=[e,...t.map(P),o,P(o),r],c=await i.db.getAll(a,s);for(let e of c)i.depend({kind:`row`,id:e.blockId});return c}}),$e=e({name:`core.blockTypesByIds`,argsSchema:a({workspaceId:s(),blockIds:n(s()).max(200)}),resultSchema:n(a({blockId:s(),type:s()})),resolve:async({workspaceId:e,blockIds:t},n)=>{if(!e||t.length===0)return[];for(let e of t)n.depend({kind:`row`,id:e});let r=t.map(()=>`?`).join(`, `);return n.db.getAll(`SELECT b.id AS blockId, je.value AS type
       ...
       ORDER BY b.id, je.key`,[e,...t])}}),et=e({name:`core.aliasClaimantCounts`,argsSchema:a({workspaceId:s(),aliases:n(s()).max(200)}),resultSchema:n(a({alias:s(),claimants:i()})),resolve:async({workspaceId:e,aliases:t},n)=>{if(!e||t.length===0)return[];n.depend({kind:`plugin`,channel:b,key:C(e)});let r=t.map(()=>`?`).join(`, `);return n.db.getAll(`SELECT ba.alias AS alias, count(*) AS claimants
       FROM block_aliases ba
       JOIN blocks b ON b.id = ba.block_id
       WHERE ba.workspace_id = ?
         AND ba.alias IN (${r})
         AND b.deleted = 0
       GROUP BY ba.alias`,[e,...t])}}),tt=e({name:`core.aliasClaimants`,argsSchema:a({workspaceId:s(),alias:s()}),resultSchema:G,resolve:async({workspaceId:e,alias:t},n)=>{if(!e||!t)return[];n.depend({kind:`plugin`,channel:b,key:C(e)});let r=await n.db.getAll(H,[e,t]);return n.hydrateBlocks(W(r))}}),nt=e({name:`core.aliasLookup`,argsSchema:a({workspaceId:s(),alias:s()}),resultSchema:De,resolve:async({workspaceId:e,alias:t},n)=>{if(!e||!t)return null;n.depend({kind:`plugin`,channel:b,key:C(e)});let r=await n.db.getOptional(V,[e,t]);return r===null?null:n.hydrateBlocks(W([r]))[0]??null}}),$=e({name:`core.findExtensionBlocks`,argsSchema:a({workspaceId:s()}),resultSchema:G,resolve:async({workspaceId:e},t)=>{if(!e)return[];let n=await t.db.getAll(O,[e,`extension`]);return t.hydrateBlocks(W(n))}}),rt=[Oe,ke,Ae,Me,Ne,Pe,He,Ue,Ge,Ke,Je,Ye,Q,Xe,Ze,Qe,$e,et,tt,nt,$];export{rt as KERNEL_QUERIES,B as SELECT_ALIASES_IN_WORKSPACE_SQL,Ce as SELECT_ALIAS_MATCHES_IN_WORKSPACE_SQL,H as SELECT_BLOCKS_BY_ALIAS_IN_WORKSPACE_SQL,F as SELECT_BLOCKS_BY_CONTENT_SQL,O as SELECT_BLOCKS_BY_TYPE_SQL,Se as SELECT_BLOCK_BY_ALIAS_IN_WORKSPACE_EXCLUDING_SQL,V as SELECT_BLOCK_BY_ALIAS_IN_WORKSPACE_SQL,ye as SELECT_BLOCK_BY_ID_SQL,we as SELECT_FIRST_CHILD_BY_CONTENT_SQL,I as SELECT_RECENT_BLOCKS_SQL,R as SELECT_RECENT_USER_BLOCKS_SQL,L as SELECT_USER_PAGE_IDS_SQL,et as aliasClaimantCountsQuery,tt as aliasClaimantsQuery,nt as aliasLookupQuery,Qe as aliasMatchesFuzzyQuery,Ze as aliasMatchesQuery,Xe as aliasesInWorkspaceQuery,ke as ancestorsQuery,$e as blockTypesByIdsQuery,U as buildFuzzyAliasMatchesSql,Pe as byTypeQuery,Ne as childIdsQuery,Me as childrenQuery,N as compileBlocksContentSearchQuery,P as escapeLikePattern,$ as findExtensionBlocksQuery,Q as firstChildByContentQuery,Ae as manyAncestorsQuery,Ye as recentActivityQuery,Je as recentBlocksQuery,z as recentUserBlocksParams,K as registrySeedParams,We as resolveTypedBlockCount,Ve as resolveTypedBlockIds,Be as resolveTypedBlocks,Ke as searchByContentQuery,Oe as subtreeQuery,Ge as typedBlockCountQuery,Ue as typedBlockIdsQuery,He as typedBlocksQuery};
