import { NodeProp, NodeSet, NodeType, Parser, Tree, parseMixed } from "../../common/dist/index.js";
import { Tag, styleTags, tags } from "../../highlight/dist/index.js";
...
var FragmentCursor = class {
	...
	takeNodes(cx) {
		...
		for (;;) {
			...
			if (cur.type.is("Block")) if (NotLast.indexOf(cur.type.id) < 0) {
				end = cur.to - off;
...
//#endregion
export { Emoji, GFM, MarkdownParser, Subscript, Superscript, parseCode, parser };
