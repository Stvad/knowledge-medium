...
import { Player_default } from "./Player.js";
import React, { Suspense, lazy, useEffect, useState } from "react";
//#region node_modules/react-player/dist/ReactPlayer.js
var Preview = lazy(() => __vitePreload(() => import(
...
var createReactPlayer = (players, playerFallback) => {
	...
	const ReactPlayer = React.forwardRef((_props, ref) => {
		...
		const renderActivePlayer = (src2) => {
			...
			return /* @__PURE__ */ React.createElement(Player_default, {
				...props,
				ref,
		...
		}, /* @__PURE__ */ React.createElement(UniversalSuspense, { fallback }, showPreview ? renderPreview(src) : renderActivePlayer(src)));
	});
