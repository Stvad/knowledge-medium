...
//#region src/utils/startupTimeline.ts
/**
...
var timeOrigin = () => typeof performance !== "undefined" ? performance.timeOrigin : 0;
...
var markStartup = (phase) => {
	if (marks[phase] === void 0) marks[phase] = nowMs();
};
...
var markStartupAt = (phase, ms) => {
	if (marks[phase] === void 0) marks[phase] = ms;
};
var hasStartupMark = (phase) => marks[phase] !== void 0;
/** Frozen snapshot of the timeline so far. */
var getStartupTimeline = () => Object.freeze({
	timeOriginMs: timeOrigin(),
	marks: Object.freeze({ ...marks })
});
var longTaskObserver = null;
var longTasksObserving = false;
var lastLongTaskEndMs = null;
var longTaskSubscribers = new CallbackSet("long-task");
...
var onLongTask = (cb) => longTaskSubscribers.add(cb);
...
//#endregion
export { getLastLongTaskEndMs, getStartupTimeline, hasStartupMark, longTasksSupported, markStartup, markStartupAt, onLongTask, resetStartupTimeline, startStartupObservers };

//# sourceMappingURL=startupTimeline.js.map