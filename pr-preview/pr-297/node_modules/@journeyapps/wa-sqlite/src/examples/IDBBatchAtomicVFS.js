import { SQLITE_IOCAP_BATCH_ATOMIC, SQLITE_IOCAP_UNDELETABLE_WHEN_OPEN, SQLITE_IOERR_ACCESS, SQLITE_IOERR_CLOSE, SQLITE_IOERR_DELETE, SQLITE_IOERR_FSTAT, SQLITE_IOERR_FSYNC, SQLITE_IOERR_TRUNCATE } from "../sqlite-constants.js";
import "../VFS.js";
...
var RETRYABLE_ERRORS = new Set(["TransactionInactiveError", "InvalidStateError"]);
/**
* @typedef Metadata
