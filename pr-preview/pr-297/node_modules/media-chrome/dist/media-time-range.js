...
import { media_preview_thumbnail_default } from "./media-preview-thumbnail.js";
...
var MediaTimeRange = class extends MediaChromeRange {
	...
	connectedCallback() {
		...
		(_a = __privateGet(this, _rootNode)) == null || _a.addEventListener("transitionstart", this);
	}
	disconnectedCallback() {
		var _a;
		super.disconnectedCallback();
		__privateGet(this, _animation).stop();
		(_a = __privateGet(this, _rootNode)) == null || _a.removeEventListener("transitionstart", this);
	...
	handleEvent(evt) {
		...
		switch (evt.type) {
			...
			case "transitionstart":
				if (containsComposedNode(evt.target, this)) setTimeout(() => __privateGet(this, _toggleRangeAnimation).call(this), 0);
				break;
		}
	}
};
