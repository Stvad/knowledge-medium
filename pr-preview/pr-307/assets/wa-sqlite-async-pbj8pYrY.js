//#region node_modules/@journeyapps/wa-sqlite/dist/wa-sqlite-async.mjs
async function Module(moduleArg = {}) {
	...
	function findWasmBinary() {
		...
		return new URL("/knowledge-medium/pr-preview/pr-307/assets/wa-sqlite-async-rHzzC98y.wasm", "" + import.meta.url).href;
	}
		...
		let innerFunc = () => {
			try {
				...
				return new Promise((resolve) => {
					...
					if (mount?.type.syncfs) mount.type.syncfs(mount, false, (err) => resolve(err ? 29 : 0));
					else resolve(rtn);
				});
			} catch (e) {
				if (typeof FS == "undefined" || !(e.name === "ErrnoError")) throw e;
	...
	var _malloc, _free, _main, _emscripten_builtin_memalign, __emscripten_timeout, __emscripten_tempret_get, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, _asyncify_start_unwind, _asyncify_stop_unwind, _asyncify_start_rewind, _asyncify_stop_rewind, wasmMemory, wasmTable;
	function assignWasmExports(wasmExports) {
		Module["_powersync_init_static"] = wasmExports["ra"];
		Module["_sqlite3_status64"] = wasmExports["sa"];
		Module["_sqlite3_status"] = wasmExports["ta"];
		Module["_sqlite3_msize"] = wasmExports["ua"];
		Module["_sqlite3_db_status"] = wasmExports["va"];
		Module["_sqlite3_vfs_find"] = wasmExports["wa"];
		Module["_sqlite3_vfs_register"] = wasmExports["xa"];
		Module["_sqlite3_vfs_unregister"] = wasmExports["ya"];
		Module["_sqlite3_release_memory"] = wasmExports["za"];
		Module["_sqlite3_soft_heap_limit64"] = wasmExports["Aa"];
		Module["_sqlite3_memory_used"] = wasmExports["Ba"];
		Module["_sqlite3_hard_heap_limit64"] = wasmExports["Ca"];
		Module["_sqlite3_memory_highwater"] = wasmExports["Da"];
		Module["_sqlite3_malloc"] = wasmExports["Ea"];
		Module["_sqlite3_malloc64"] = wasmExports["Fa"];
		Module["_sqlite3_free"] = wasmExports["Ga"];
		Module["_sqlite3_realloc"] = wasmExports["Ha"];
		Module["_sqlite3_realloc64"] = wasmExports["Ia"];
		Module["_sqlite3_str_vappendf"] = wasmExports["Ja"];
		Module["_sqlite3_str_append"] = wasmExports["Ka"];
		Module["_sqlite3_str_appendchar"] = wasmExports["La"];
		Module["_sqlite3_str_appendall"] = wasmExports["Ma"];
		Module["_sqlite3_str_appendf"] = wasmExports["Na"];
		Module["_sqlite3_str_finish"] = wasmExports["Oa"];
		Module["_sqlite3_str_errcode"] = wasmExports["Pa"];
		Module["_sqlite3_str_length"] = wasmExports["Qa"];
		Module["_sqlite3_str_value"] = wasmExports["Ra"];
		Module["_sqlite3_str_reset"] = wasmExports["Sa"];
		Module["_sqlite3_str_new"] = wasmExports["Ta"];
		Module["_sqlite3_vmprintf"] = wasmExports["Ua"];
		Module["_sqlite3_mprintf"] = wasmExports["Va"];
		Module["_sqlite3_vsnprintf"] = wasmExports["Wa"];
		Module["_sqlite3_snprintf"] = wasmExports["Xa"];
		Module["_sqlite3_log"] = wasmExports["Ya"];
		Module["_sqlite3_randomness"] = wasmExports["Za"];
		Module["_sqlite3_stricmp"] = wasmExports["_a"];
		Module["_sqlite3_strnicmp"] = wasmExports["$a"];
		Module["_sqlite3_os_init"] = wasmExports["ab"];
		Module["_sqlite3_os_end"] = wasmExports["bb"];
		Module["_sqlite3_serialize"] = wasmExports["cb"];
		Module["_sqlite3_prepare_v2"] = wasmExports["db"];
		Module["_sqlite3_step"] = wasmExports["eb"];
		Module["_sqlite3_column_int64"] = wasmExports["fb"];
		Module["_sqlite3_reset"] = wasmExports["gb"];
		Module["_sqlite3_exec"] = wasmExports["hb"];
		Module["_sqlite3_column_int"] = wasmExports["ib"];
		Module["_sqlite3_finalize"] = wasmExports["jb"];
		Module["_sqlite3_deserialize"] = wasmExports["kb"];
		Module["_sqlite3_database_file_object"] = wasmExports["lb"];
		Module["_sqlite3_backup_init"] = wasmExports["mb"];
		Module["_sqlite3_backup_step"] = wasmExports["nb"];
		Module["_sqlite3_backup_finish"] = wasmExports["ob"];
		Module["_sqlite3_backup_remaining"] = wasmExports["pb"];
		Module["_sqlite3_backup_pagecount"] = wasmExports["qb"];
		Module["_sqlite3_clear_bindings"] = wasmExports["rb"];
		Module["_sqlite3_value_blob"] = wasmExports["sb"];
		Module["_sqlite3_value_text"] = wasmExports["tb"];
		Module["_sqlite3_value_bytes"] = wasmExports["ub"];
		Module["_sqlite3_value_bytes16"] = wasmExports["vb"];
		Module["_sqlite3_value_double"] = wasmExports["wb"];
		Module["_sqlite3_value_int"] = wasmExports["xb"];
		Module["_sqlite3_value_int64"] = wasmExports["yb"];
		Module["_sqlite3_value_subtype"] = wasmExports["zb"];
		Module["_sqlite3_value_pointer"] = wasmExports["Ab"];
		Module["_sqlite3_value_text16"] = wasmExports["Bb"];
		Module["_sqlite3_value_text16be"] = wasmExports["Cb"];
		Module["_sqlite3_value_text16le"] = wasmExports["Db"];
		Module["_sqlite3_value_type"] = wasmExports["Eb"];
		Module["_sqlite3_value_encoding"] = wasmExports["Fb"];
		Module["_sqlite3_value_nochange"] = wasmExports["Gb"];
		Module["_sqlite3_value_frombind"] = wasmExports["Hb"];
		Module["_sqlite3_value_dup"] = wasmExports["Ib"];
		Module["_sqlite3_value_free"] = wasmExports["Jb"];
		Module["_sqlite3_result_blob"] = wasmExports["Kb"];
		Module["_sqlite3_result_blob64"] = wasmExports["Lb"];
		Module["_sqlite3_result_double"] = wasmExports["Mb"];
		Module["_sqlite3_result_error"] = wasmExports["Nb"];
		Module["_sqlite3_result_error16"] = wasmExports["Ob"];
		Module["_sqlite3_result_int"] = wasmExports["Pb"];
		Module["_sqlite3_result_int64"] = wasmExports["Qb"];
		Module["_sqlite3_result_null"] = wasmExports["Rb"];
		Module["_sqlite3_result_pointer"] = wasmExports["Sb"];
		Module["_sqlite3_result_subtype"] = wasmExports["Tb"];
		Module["_sqlite3_result_text"] = wasmExports["Ub"];
		Module["_sqlite3_result_text64"] = wasmExports["Vb"];
		Module["_sqlite3_result_text16"] = wasmExports["Wb"];
		Module["_sqlite3_result_text16be"] = wasmExports["Xb"];
		Module["_sqlite3_result_text16le"] = wasmExports["Yb"];
		Module["_sqlite3_result_value"] = wasmExports["Zb"];
		Module["_sqlite3_result_error_toobig"] = wasmExports["_b"];
		Module["_sqlite3_result_zeroblob"] = wasmExports["$b"];
		Module["_sqlite3_result_zeroblob64"] = wasmExports["ac"];
		Module["_sqlite3_result_error_code"] = wasmExports["bc"];
		Module["_sqlite3_result_error_nomem"] = wasmExports["cc"];
		Module["_sqlite3_user_data"] = wasmExports["dc"];
		Module["_sqlite3_context_db_handle"] = wasmExports["ec"];
		Module["_sqlite3_vtab_nochange"] = wasmExports["fc"];
		Module["_sqlite3_vtab_in_first"] = wasmExports["gc"];
		Module["_sqlite3_vtab_in_next"] = wasmExports["hc"];
		Module["_sqlite3_aggregate_context"] = wasmExports["ic"];
		Module["_sqlite3_get_auxdata"] = wasmExports["jc"];
		Module["_sqlite3_set_auxdata"] = wasmExports["kc"];
		Module["_sqlite3_column_count"] = wasmExports["lc"];
		Module["_sqlite3_data_count"] = wasmExports["mc"];
		Module["_sqlite3_column_blob"] = wasmExports["nc"];
		Module["_sqlite3_column_bytes"] = wasmExports["oc"];
		Module["_sqlite3_column_bytes16"] = wasmExports["pc"];
		Module["_sqlite3_column_double"] = wasmExports["qc"];
		Module["_sqlite3_column_text"] = wasmExports["rc"];
		Module["_sqlite3_column_value"] = wasmExports["sc"];
		Module["_sqlite3_column_text16"] = wasmExports["tc"];
		Module["_sqlite3_column_type"] = wasmExports["uc"];
		Module["_sqlite3_column_name"] = wasmExports["vc"];
		Module["_sqlite3_column_name16"] = wasmExports["wc"];
		Module["_sqlite3_bind_blob"] = wasmExports["xc"];
		Module["_sqlite3_bind_blob64"] = wasmExports["yc"];
		Module["_sqlite3_bind_double"] = wasmExports["zc"];
		Module["_sqlite3_bind_int"] = wasmExports["Ac"];
		Module["_sqlite3_bind_int64"] = wasmExports["Bc"];
		Module["_sqlite3_bind_null"] = wasmExports["Cc"];
		Module["_sqlite3_bind_pointer"] = wasmExports["Dc"];
		Module["_sqlite3_bind_text"] = wasmExports["Ec"];
		Module["_sqlite3_bind_text64"] = wasmExports["Fc"];
		Module["_sqlite3_bind_text16"] = wasmExports["Gc"];
		Module["_sqlite3_bind_value"] = wasmExports["Hc"];
		Module["_sqlite3_bind_zeroblob"] = wasmExports["Ic"];
		Module["_sqlite3_bind_zeroblob64"] = wasmExports["Jc"];
		Module["_sqlite3_bind_parameter_count"] = wasmExports["Kc"];
		Module["_sqlite3_bind_parameter_name"] = wasmExports["Lc"];
		Module["_sqlite3_bind_parameter_index"] = wasmExports["Mc"];
		Module["_sqlite3_db_handle"] = wasmExports["Nc"];
		Module["_sqlite3_stmt_readonly"] = wasmExports["Oc"];
		Module["_sqlite3_stmt_isexplain"] = wasmExports["Pc"];
		Module["_sqlite3_stmt_explain"] = wasmExports["Qc"];
		Module["_sqlite3_stmt_busy"] = wasmExports["Rc"];
		Module["_sqlite3_next_stmt"] = wasmExports["Sc"];
		Module["_sqlite3_stmt_status"] = wasmExports["Tc"];
		Module["_sqlite3_sql"] = wasmExports["Uc"];
		Module["_sqlite3_expanded_sql"] = wasmExports["Vc"];
		Module["_sqlite3_value_numeric_type"] = wasmExports["Wc"];
		Module["_sqlite3_blob_open"] = wasmExports["Xc"];
		Module["_sqlite3_blob_close"] = wasmExports["Yc"];
		Module["_sqlite3_blob_read"] = wasmExports["Zc"];
		Module["_sqlite3_blob_write"] = wasmExports["_c"];
		Module["_sqlite3_blob_bytes"] = wasmExports["$c"];
		Module["_sqlite3_blob_reopen"] = wasmExports["ad"];
		Module["_sqlite3_set_authorizer"] = wasmExports["bd"];
		Module["_sqlite3_strglob"] = wasmExports["cd"];
		Module["_sqlite3_strlike"] = wasmExports["dd"];
		Module["_sqlite3_errmsg"] = wasmExports["ed"];
		Module["_sqlite3_load_extension"] = wasmExports["fd"];
		Module["_sqlite3_enable_load_extension"] = wasmExports["gd"];
		Module["_sqlite3_auto_extension"] = wasmExports["hd"];
		Module["_sqlite3_cancel_auto_extension"] = wasmExports["id"];
		Module["_sqlite3_reset_auto_extension"] = wasmExports["jd"];
		Module["_sqlite3_prepare"] = wasmExports["kd"];
		Module["_sqlite3_prepare_v3"] = wasmExports["ld"];
		Module["_sqlite3_prepare16"] = wasmExports["md"];
		Module["_sqlite3_prepare16_v2"] = wasmExports["nd"];
		Module["_sqlite3_prepare16_v3"] = wasmExports["od"];
		Module["_sqlite3_get_table"] = wasmExports["pd"];
		Module["_sqlite3_free_table"] = wasmExports["qd"];
		Module["_sqlite3_create_module"] = wasmExports["rd"];
		Module["_sqlite3_create_module_v2"] = wasmExports["sd"];
		Module["_sqlite3_drop_modules"] = wasmExports["td"];
		Module["_sqlite3_declare_vtab"] = wasmExports["ud"];
		Module["_sqlite3_vtab_on_conflict"] = wasmExports["vd"];
		Module["_sqlite3_vtab_config"] = wasmExports["wd"];
		Module["_sqlite3_vtab_collation"] = wasmExports["xd"];
		Module["_sqlite3_vtab_in"] = wasmExports["yd"];
		Module["_sqlite3_vtab_rhs_value"] = wasmExports["zd"];
		Module["_sqlite3_vtab_distinct"] = wasmExports["Ad"];
		Module["_sqlite3_keyword_name"] = wasmExports["Bd"];
		Module["_sqlite3_keyword_count"] = wasmExports["Cd"];
		Module["_sqlite3_keyword_check"] = wasmExports["Dd"];
		Module["_sqlite3_complete"] = wasmExports["Ed"];
		Module["_sqlite3_complete16"] = wasmExports["Fd"];
		Module["_sqlite3_libversion"] = wasmExports["Gd"];
		Module["_sqlite3_libversion_number"] = wasmExports["Hd"];
		Module["_sqlite3_threadsafe"] = wasmExports["Id"];
		Module["_sqlite3_initialize"] = wasmExports["Jd"];
		Module["_sqlite3_shutdown"] = wasmExports["Kd"];
		Module["_sqlite3_config"] = wasmExports["Ld"];
		Module["_sqlite3_db_mutex"] = wasmExports["Md"];
		Module["_sqlite3_db_release_memory"] = wasmExports["Nd"];
		Module["_sqlite3_db_cacheflush"] = wasmExports["Od"];
		Module["_sqlite3_db_config"] = wasmExports["Pd"];
		Module["_sqlite3_last_insert_rowid"] = wasmExports["Qd"];
		Module["_sqlite3_set_last_insert_rowid"] = wasmExports["Rd"];
		Module["_sqlite3_changes64"] = wasmExports["Sd"];
		Module["_sqlite3_changes"] = wasmExports["Td"];
		Module["_sqlite3_total_changes64"] = wasmExports["Ud"];
		Module["_sqlite3_total_changes"] = wasmExports["Vd"];
		Module["_sqlite3_txn_state"] = wasmExports["Wd"];
		Module["_sqlite3_close"] = wasmExports["Xd"];
		Module["_sqlite3_close_v2"] = wasmExports["Yd"];
		Module["_sqlite3_busy_handler"] = wasmExports["Zd"];
		Module["_sqlite3_progress_handler"] = wasmExports["_d"];
		Module["_sqlite3_busy_timeout"] = wasmExports["$d"];
		Module["_sqlite3_interrupt"] = wasmExports["ae"];
		Module["_sqlite3_is_interrupted"] = wasmExports["be"];
		Module["_sqlite3_create_function"] = wasmExports["ce"];
		Module["_sqlite3_create_function_v2"] = wasmExports["de"];
		Module["_sqlite3_create_window_function"] = wasmExports["ee"];
		Module["_sqlite3_create_function16"] = wasmExports["fe"];
		Module["_sqlite3_overload_function"] = wasmExports["ge"];
		Module["_sqlite3_trace_v2"] = wasmExports["he"];
		Module["_sqlite3_commit_hook"] = wasmExports["ie"];
		Module["_sqlite3_update_hook"] = wasmExports["je"];
		Module["_sqlite3_rollback_hook"] = wasmExports["ke"];
		Module["_sqlite3_autovacuum_pages"] = wasmExports["le"];
		Module["_sqlite3_wal_autocheckpoint"] = wasmExports["me"];
		Module["_sqlite3_wal_hook"] = wasmExports["ne"];
		Module["_sqlite3_wal_checkpoint_v2"] = wasmExports["oe"];
		Module["_sqlite3_wal_checkpoint"] = wasmExports["pe"];
		Module["_sqlite3_error_offset"] = wasmExports["qe"];
		Module["_sqlite3_errmsg16"] = wasmExports["re"];
		Module["_sqlite3_errcode"] = wasmExports["se"];
		Module["_sqlite3_extended_errcode"] = wasmExports["te"];
		Module["_sqlite3_system_errno"] = wasmExports["ue"];
		Module["_sqlite3_errstr"] = wasmExports["ve"];
		Module["_sqlite3_limit"] = wasmExports["we"];
		Module["_sqlite3_open"] = wasmExports["xe"];
		Module["_sqlite3_open_v2"] = wasmExports["ye"];
		Module["_sqlite3_open16"] = wasmExports["ze"];
		Module["_sqlite3_create_collation"] = wasmExports["Ae"];
		Module["_sqlite3_create_collation_v2"] = wasmExports["Be"];
		Module["_sqlite3_create_collation16"] = wasmExports["Ce"];
		Module["_sqlite3_collation_needed"] = wasmExports["De"];
		Module["_sqlite3_collation_needed16"] = wasmExports["Ee"];
		Module["_sqlite3_get_clientdata"] = wasmExports["Fe"];
		Module["_sqlite3_set_clientdata"] = wasmExports["Ge"];
		Module["_sqlite3_get_autocommit"] = wasmExports["He"];
		Module["_sqlite3_table_column_metadata"] = wasmExports["Ie"];
		Module["_sqlite3_sleep"] = wasmExports["Je"];
		Module["_sqlite3_extended_result_codes"] = wasmExports["Ke"];
		Module["_sqlite3_file_control"] = wasmExports["Le"];
		Module["_sqlite3_test_control"] = wasmExports["Me"];
		Module["_sqlite3_create_filename"] = wasmExports["Ne"];
		Module["_sqlite3_free_filename"] = wasmExports["Oe"];
		Module["_sqlite3_uri_parameter"] = wasmExports["Pe"];
		Module["_sqlite3_uri_key"] = wasmExports["Qe"];
		Module["_sqlite3_uri_boolean"] = wasmExports["Re"];
		Module["_sqlite3_uri_int64"] = wasmExports["Se"];
		Module["_sqlite3_filename_database"] = wasmExports["Te"];
		Module["_sqlite3_filename_journal"] = wasmExports["Ue"];
		Module["_sqlite3_filename_wal"] = wasmExports["Ve"];
		Module["_sqlite3_db_name"] = wasmExports["We"];
		Module["_sqlite3_db_filename"] = wasmExports["Xe"];
		Module["_sqlite3_db_readonly"] = wasmExports["Ye"];
		Module["_sqlite3_compileoption_used"] = wasmExports["Ze"];
		Module["_sqlite3_compileoption_get"] = wasmExports["_e"];
		Module["_sqlite3_sourceid"] = wasmExports["$e"];
		Module["_memcmp"] = wasmExports["af"];
		_malloc = Module["_malloc"] = wasmExports["bf"];
		_free = Module["_free"] = wasmExports["cf"];
		Module["_RegisterExtensionFunctions"] = wasmExports["ef"];
		Module["_getSqliteFree"] = wasmExports["ff"];
		_main = Module["_main"] = wasmExports["gf"];
		Module["_libauthorizer_set_authorizer"] = wasmExports["hf"];
		Module["_libfunction_create_function"] = wasmExports["jf"];
		Module["_libhook_commit_hook"] = wasmExports["kf"];
		Module["_libhook_update_hook"] = wasmExports["lf"];
		Module["_libprogress_progress_handler"] = wasmExports["mf"];
		Module["_libvfs_vfs_register"] = wasmExports["nf"];
		Module["_memcpy"] = wasmExports["of"];
		Module["_memset"] = wasmExports["pf"];
		...
		dynCalls["iii"] = wasmExports["xf"];
		dynCalls["iiii"] = wasmExports["yf"];
		dynCalls["viii"] = wasmExports["zf"];
		dynCalls["vi"] = wasmExports["Af"];
		dynCalls["viiiij"] = wasmExports["Bf"];
		dynCalls["ii"] = wasmExports["Cf"];
		dynCalls["iiiiiii"] = wasmExports["Df"];
		dynCalls["iiiiii"] = wasmExports["Ef"];
		dynCalls["iiiii"] = wasmExports["Ff"];
		dynCalls["vii"] = wasmExports["Gf"];
		dynCalls["viiii"] = wasmExports["Hf"];
		dynCalls["iiiiiiiii"] = wasmExports["If"];
		dynCalls["vijii"] = wasmExports["Jf"];
		dynCalls["viiiii"] = wasmExports["Kf"];
		dynCalls["iiiij"] = wasmExports["Lf"];
		dynCalls["viji"] = wasmExports["Mf"];
		dynCalls["iij"] = wasmExports["Nf"];
		dynCalls["iidiiii"] = wasmExports["Of"];
		dynCalls["iijii"] = wasmExports["Pf"];
		dynCalls["iiji"] = wasmExports["Qf"];
		dynCalls["i"] = wasmExports["Rf"];
		dynCalls["iiiiiij"] = wasmExports["Sf"];
		dynCalls["iiid"] = wasmExports["Tf"];
		dynCalls["iiij"] = wasmExports["Uf"];
		dynCalls["dii"] = wasmExports["Vf"];
		dynCalls["jii"] = wasmExports["Wf"];
		dynCalls["ji"] = wasmExports["Xf"];
		dynCalls["vid"] = wasmExports["Yf"];
		dynCalls["vij"] = wasmExports["Zf"];
		dynCalls["iiiiiiiiii"] = wasmExports["_f"];
		dynCalls["di"] = wasmExports["$f"];
		dynCalls["iiiiijii"] = wasmExports["ag"];
		dynCalls["j"] = wasmExports["bg"];
		dynCalls["jj"] = wasmExports["cg"];
		dynCalls["jiij"] = wasmExports["dg"];
		dynCalls["iiiiji"] = wasmExports["eg"];
		dynCalls["iiiijii"] = wasmExports["fg"];
		dynCalls["ij"] = wasmExports["gg"];
		dynCalls["v"] = wasmExports["hg"];
		dynCalls["viiji"] = wasmExports["ig"];
		dynCalls["viijii"] = wasmExports["jg"];
		dynCalls["iiiiiiiiiii"] = wasmExports["kg"];
		dynCalls["iiiijji"] = wasmExports["lg"];
		dynCalls["iiiiiiii"] = wasmExports["mg"];
		_asyncify_start_unwind = wasmExports["ng"];
		_asyncify_stop_unwind = wasmExports["og"];
		_asyncify_start_rewind = wasmExports["pg"];
		_asyncify_stop_rewind = wasmExports["qg"];
		wasmMemory = wasmExports["pa"];
		Module["_sqlite3_version"] = wasmExports["df"].value;
...
//# sourceMappingURL=wa-sqlite-async-pbj8pYrY.js.map