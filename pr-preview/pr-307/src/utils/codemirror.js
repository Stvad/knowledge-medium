...
//#endregion
export { acceptCompletionBeforeIOSDefer, acceptCompletionOnEnterCapture, createMinimalMarkdownConfig, createTypeScriptConfig, cursorIsAtEnd, cursorIsAtStart, getCaretRect, getVisualColumn, isOnFirstVisualLine, isOnLastVisualLine, markdownFormattingKeymap, placeCursorAtCoords, placeCursorAtX, softLineBreakOnBeforeInput, toggleMarkdownBold, toggleMarkdownInlineCode, toggleMarkdownItalic, toggleMarkdownStrikethrough, wrapRangeWithPair };
