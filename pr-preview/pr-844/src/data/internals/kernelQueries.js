...
`,Y=(e,t,n,r)=>{if(e!==void 0)for(let[i,a]of Object.entries(e)){if(n.depend({kind:`plugin`,channel:pe,key:ge(t,i)}),typeof a!=`object`||!a||a instanceof Date||Array.isArray(a))continue;let e=Object.entries(a);if(e.length!==1)continue;let[o,s]=e[0];if(o!==`target`||typeof s!=`object`||!s||Array.isArray(s))continue;let c=s;Object.values(c).some(y)||(r?r.add(i):n.depend({kind:`plugin`,channel:fe,key:D(t)})),Y(c,t,n,null)}},ze=(e,t,n,r={})=>{if(e.sourceField!==void 0){n.depend({kind:`plugin`,channel:he,key:_e(t,e.id,e.sourceField)});return}n.depend({kind:`plugin`,channel:me,key:ve(t,e.id)}),r.includeImplicitAncestorStructure&&n.depend({kind:`plugin`,channel:C,key:O(t,e.id)})},Be=(e,t,n,r)=>{for(let i of e)Y(i.where,t,n,i.scope===`ancestor`?r:null),i.referencedBy!==void 0&&ze(i.referencedBy,t,n,{includeImplicitAncestorStructure:i.scope===`ancestor`})},X=(e,t)=>{let n=e.workspaceId,r=e.types??[],i=e.referencedBy,a=e.match??[],o=e.exclude??[];for(let e of r)t.depend({kind:`plugin`,channel:w,key:k(n,e)});let s=new Set;Y(e.where,n,t,null),i!==void 0&&ze(i,n,t),Be(a,n,t,s),Be(o,n,t,s);let c=Object.values(e.where??{}).some(y),l=a.some(e=>e.referencedBy!==void 0||e.where!==void 0&&Object.values(e.where).some(y));return r.length>0||i!==void 0||c||l||t.depend({kind:`plugin`,channel:fe,key:D(n)}),{workspaceId:n,types:r,referencedBy:i,matchPredicates:a,excludePredicates:o,ancestorTargetProps:s}},Z=(e,t)=>e.some(e=>e.scope===`ancestor`)||t.some(e=>e.scope===`ancestor`),Ve=(e,t)=>{let n=[];for(let r of[...e].sort()){let e=`json_extract(b.properties_json, ${de(r)})`,i=ne(t.get(r));i===`ref`?n.push(`SELECT DISTINCT '${J}', ${e}\n  FROM walk JOIN blocks b ON b.id = walk.anc_id\n  WHERE ${e} IS NOT NULL`):i===`refList`&&n.push(`SELECT DISTINCT '${J}', je.value\n  FROM walk JOIN blocks b ON b.id = walk.anc_id, json_each(${e}) je`)}return n},Q=async(e,t,n,r)=>{le(e);let i=ue(e,t.repo.propertySchemas),a=await t.db.getAll(Re(i.sql,Ve(r,t.repo.propertySchemas)),i.params);for(let r of a)if(r.dep_id!==null){if(r.dep_kind===J){t.depend({kind:`plugin`,channel:C,key:O(e.workspaceId,r.dep_id)});continue}n===`row`?t.depend({kind:`row`,id:r.dep_id}):t.depend({kind:`plugin`,channel:C,key:O(e.workspaceId,r.dep_id)})}},He=async(e,t)=>{if(!e.workspaceId)return[];let n=b(e),{workspaceId:r,types:i,referencedBy:a,matchPredicates:o,excludePredicates:s,ancestorTargetProps:c}=X(n,t);if(Z(o,s)&&await Q(n,t,`row`,c),i.length===1&&n.where===void 0&&a===void 0&&o.length===0&&s.length===0&&n.order!==`created-desc`){let e=await t.db.getAll(A,[r,i[0]]);return t.hydrateBlocks(W(e))}let l=v(n,t.repo.propertySchemas),u=await t.db.getAll(l.sql,[...l.params]);return t.hydrateBlocks(W(u))},Ue=async(e,t)=>{if(!e.workspaceId)return[];let n=b(e),{matchPredicates:r,excludePredicates:i,ancestorTargetProps:a}=X(n,t);Z(r,i)&&await Q(n,t,`structure`,a);let o=v(n,t.repo.propertySchemas,{projection:`ids`});return(await t.db.getAll(o.sql,[...o.params])).map(e=>e.id)},We=e({name:`core.typedBlocks`,argsSchema:q,resultSchema:G,resolve:(e,t)=>He(e,t)}),$=e({name:`core.typedBlockIds`,argsSchema:q,resultSchema:De,resolve:(e,t)=>Ue(e,t)}),Ge=async(e,t)=>{if(!e.workspaceId)return 0;let n=b(e),{matchPredicates:r,excludePredicates:i,ancestorTargetProps:a}=X(n,t);Z(r,i)&&await Q(n,t,`structure`,a);let o=v(n,t.repo.propertySchemas,{projection:`count`});return(await t.db.get(o.sql,[...o.params]))?.count??0},Ke=e({name:`core.typedBlockCount`,argsSchema:q,resultSchema:Oe,resolve:(e,t)=>Ge(e,t)}),qe=e({name:`core.searchByContent`,argsSchema:a({workspaceId:s(),query:s(),limit:i().optional()}),resultSchema:G,resolve:async({workspaceId:e,query:t,limit:n=50},r)=>{let i=F(t);if(i===null)return[];r.depend({kind:`plugin`,channel:S,key:E(e)});let a=await r.db.getAll(L,[e,i.matchQuery,i.rankQuery,I(i.rankQuery),n]);return r.hydrateBlocks(W(a),{declareRowDeps:!1})}}),Je=async(e,t)=>(await e.db.getAll(z,[t,f])).flatMap(e=>p(e.id)),Ye=e({name:`core.recentBlocks`,argsSchema:a({workspaceId:s(),limit:i().optional()}),resultSchema:G,resolve:async({workspaceId:e,limit:t=50},n)=>{if(!e)return[];n.depend({kind:`plugin`,channel:S,key:E(e)});let r=await n.db.getAll(R,[e,t]);return n.hydrateBlocks(W(r),{declareRowDeps:!1})}}),Xe=e({name:`core.recentActivity`,argsSchema:a({workspaceId:s(),limit:i().optional()}),resultSchema:{parse:e=>e},resolve:async({workspaceId:e,limit:t=50},n)=>{if(!e)return[];n.depend({kind:`plugin`,channel:S,key:E(e)});let r=await n.db.getAll(B,V(await Je(n,e),e,t)),i=n.hydrateBlocks(W(r),{declareRowDeps:!1});if(i.length===0)return[];let a=await n.db.getAll(_(i.length),i.map(e=>e.id)),o=new Map;for(let e of i)o.set(e.id,[]);for(let e of a)o.get(e.chain_start_id)?.push(e);return i.map(t=>{let r=n.hydrateBlocks(W(o.get(t.id)??[]),{declareRowDeps:!1});for(let i of[t,...r])n.depend({kind:`plugin`,channel:C,key:O(e,i.id)});return{block:t,ancestors:r}})}}),Ze=e({name:`core.firstChildByContent`,argsSchema:a({parentId:s(),content:s()}),resultSchema:ke,resolve:async({parentId:e,content:t},n)=>{n.depend({kind:`parent-edge`,parentId:e});let r=await n.db.getAll(ae,[e]);for(let e of r)n.depend({kind:`row`,id:e.id});let i=await n.db.getOptional(Ee,[e,t]);return i===null?null:n.hydrateBlocks(W([i]),{declareRowDeps:!1})[0]??null}}),Qe=e({name:`core.aliasesInWorkspace`,argsSchema:a({workspaceId:s(),filter:s().optional()}),resultSchema:n(s()),resolve:async({workspaceId:e,filter:t=``},n)=>{if(!e)return[];n.depend({kind:`plugin`,channel:x,key:T(e)});let r=I(t);return(await n.db.getAll(H,[e,t,r,t,r])).map(e=>e.alias)}}),$e=e({name:`core.aliasMatches`,argsSchema:a({workspaceId:s(),filter:s(),limit:i().optional()}),resultSchema:n(a({alias:s(),blockId:s(),content:s()})),resolve:async({workspaceId:e,filter:t,limit:n=50},r)=>{if(!e)return[];r.depend({kind:`plugin`,channel:x,key:T(e)});let i=I(t),a=await r.db.getAll(Te,[e,t,i,t,i,n]);for(let e of a)r.depend({kind:`row`,id:e.blockId});return a}}),et=e({name:`core.aliasMatchesFuzzy`,argsSchema:a({workspaceId:s(),prefixes:n(s()),query:s().optional(),limit:i().optional()}),resultSchema:n(a({alias:s(),blockId:s(),content:s(),updatedAt:i()})),resolve:async({workspaceId:e,prefixes:t,query:n=``,limit:r=100},i)=>{if(!e)return[];i.depend({kind:`plugin`,channel:x,key:T(e)});let a=we(t.length),o=n.toLowerCase(),s=[e,...t.map(I),o,I(o),r],c=await i.db.getAll(a,s);for(let e of c)i.depend({kind:`row`,id:e.blockId});return c}}),tt=e({name:`core.blockTypesByIds`,argsSchema:a({workspaceId:s(),blockIds:n(s()).max(200)}),resultSchema:n(a({blockId:s(),type:s()})),resolve:async({workspaceId:e,blockIds:t},n)=>{if(!e||t.length===0)return[];for(let e of t)n.depend({kind:`row`,id:e});let r=t.map(()=>`?`).join(`, `);return n.db.getAll(`SELECT b.id AS blockId, je.value AS type
       ...
       ORDER BY b.id, je.key`,[e,...t])}}),nt=e({name:`core.aliasClaimantCounts`,argsSchema:a({workspaceId:s(),aliases:n(s()).max(200)}),resultSchema:n(a({alias:s(),claimants:i()})),resolve:async({workspaceId:e,aliases:t},n)=>{if(!e||t.length===0)return[];n.depend({kind:`plugin`,channel:x,key:T(e)});let r=t.map(()=>`?`).join(`, `);return n.db.getAll(`SELECT ba.alias AS alias, count(*) AS claimants
       FROM block_aliases ba
       JOIN blocks b ON b.id = ba.block_id
       WHERE ba.workspace_id = ?
         AND ba.alias IN (${r})
         AND b.deleted = 0
       GROUP BY ba.alias`,[e,...t])}}),rt=e({name:`core.aliasClaimants`,argsSchema:a({workspaceId:s(),alias:s()}),resultSchema:G,resolve:async({workspaceId:e,alias:t},n)=>{if(!e||!t)return[];n.depend({kind:`plugin`,channel:x,key:T(e)});let r=await n.db.getAll(Se,[e,t]);return n.hydrateBlocks(W(r))}}),it=e({name:`core.aliasLookup`,argsSchema:a({workspaceId:s(),alias:s()}),resultSchema:ke,resolve:async({workspaceId:e,alias:t},n)=>{if(!e||!t)return null;n.depend({kind:`plugin`,channel:x,key:T(e)});let r=await n.db.getOptional(U,[e,t]);return r===null?null:n.hydrateBlocks(W([r]))[0]??null}}),at=e({name:`core.findExtensionBlocks`,argsSchema:a({workspaceId:s()}),resultSchema:G,resolve:async({workspaceId:e},t)=>{if(!e)return[];let n=await t.db.getAll(A,[e,`extension`]);return t.hydrateBlocks(W(n))}}),ot=[Ae,je,Me,Pe,Fe,Ie,We,$,Ke,qe,Ye,Xe,Ze,Qe,$e,et,tt,nt,rt,it,at];export{ot as KERNEL_QUERIES,H as SELECT_ALIASES_IN_WORKSPACE_SQL,Te as SELECT_ALIAS_MATCHES_IN_WORKSPACE_SQL,Se as SELECT_BLOCKS_BY_ALIAS_IN_WORKSPACE_SQL,L as SELECT_BLOCKS_BY_CONTENT_SQL,A as SELECT_BLOCKS_BY_TYPE_SQL,Ce as SELECT_BLOCK_BY_ALIAS_IN_WORKSPACE_EXCLUDING_SQL,U as SELECT_BLOCK_BY_ALIAS_IN_WORKSPACE_SQL,ye as SELECT_BLOCK_BY_ID_SQL,Ee as SELECT_FIRST_CHILD_BY_CONTENT_SQL,R as SELECT_RECENT_BLOCKS_SQL,B as SELECT_RECENT_USER_BLOCKS_SQL,z as SELECT_USER_PAGE_IDS_SQL,nt as aliasClaimantCountsQuery,rt as aliasClaimantsQuery,it as aliasLookupQuery,et as aliasMatchesFuzzyQuery,$e as aliasMatchesQuery,Qe as aliasesInWorkspaceQuery,je as ancestorsQuery,tt as blockTypesByIdsQuery,we as buildFuzzyAliasMatchesSql,Ie as byTypeQuery,Fe as childIdsQuery,Pe as childrenQuery,F as compileBlocksContentSearchQuery,I as escapeLikePattern,at as findExtensionBlocksQuery,Ze as firstChildByContentQuery,Me as manyAncestorsQuery,Xe as recentActivityQuery,Ye as recentBlocksQuery,V as recentUserBlocksParams,K as registrySeedParams,Ge as resolveTypedBlockCount,Ue as resolveTypedBlockIds,He as resolveTypedBlocks,qe as searchByContentQuery,Ae as subtreeQuery,Ke as typedBlockCountQuery,$ as typedBlockIdsQuery,We as typedBlocksQuery};
