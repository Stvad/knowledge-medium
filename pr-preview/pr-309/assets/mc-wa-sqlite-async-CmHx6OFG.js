//#region node_modules/@journeyapps/wa-sqlite/dist/mc-wa-sqlite-async.mjs
async function Module(moduleArg = {}) {
	...
	function findWasmBinary() {
		if (Module["locateFile"]) return locateFile("mc-wa-sqlite-async.wasm");
		return new URL("/knowledge-medium/pr-preview/pr-309/assets/mc-wa-sqlite-async-D6idQS2r.wasm", "" + import.meta.url).href;
	}
	...
	function assignWasmExports(wasmExports) {
		Module["_powersync_init_static"] = wasmExports["sa"];
		Module["_sqlite3_status64"] = wasmExports["ta"];
		Module["_sqlite3_status"] = wasmExports["ua"];
		Module["_sqlite3_msize"] = wasmExports["va"];
		Module["_sqlite3_db_status"] = wasmExports["wa"];
		...
		Module["_sqlite3_load_extension"] = wasmExports["gd"];
		Module["_sqlite3_enable_load_extension"] = wasmExports["hd"];
		Module["_sqlite3_auto_extension"] = wasmExports["id"];
		Module["_sqlite3_cancel_auto_extension"] = wasmExports["jd"];
		Module["_sqlite3_reset_auto_extension"] = wasmExports["kd"];
		Module["_sqlite3_prepare"] = wasmExports["ld"];
		Module["_sqlite3_prepare_v3"] = wasmExports["md"];
		Module["_sqlite3_prepare16"] = wasmExports["nd"];
		Module["_sqlite3_prepare16_v2"] = wasmExports["od"];
		Module["_sqlite3_prepare16_v3"] = wasmExports["pd"];
		Module["_sqlite3_get_table"] = wasmExports["qd"];
		Module["_sqlite3_free_table"] = wasmExports["rd"];
		Module["_sqlite3_create_module"] = wasmExports["sd"];
		Module["_sqlite3_create_module_v2"] = wasmExports["td"];
		Module["_sqlite3_drop_modules"] = wasmExports["ud"];
		Module["_sqlite3_declare_vtab"] = wasmExports["vd"];
		Module["_sqlite3_vtab_on_conflict"] = wasmExports["wd"];
		Module["_sqlite3_vtab_config"] = wasmExports["xd"];
		Module["_sqlite3_vtab_collation"] = wasmExports["yd"];
		Module["_sqlite3_vtab_in"] = wasmExports["zd"];
		Module["_sqlite3_vtab_rhs_value"] = wasmExports["Ad"];
		Module["_sqlite3_vtab_distinct"] = wasmExports["Bd"];
		Module["_sqlite3_keyword_name"] = wasmExports["Cd"];
		Module["_sqlite3_keyword_count"] = wasmExports["Dd"];
		Module["_sqlite3_keyword_check"] = wasmExports["Ed"];
		Module["_sqlite3_complete"] = wasmExports["Fd"];
		Module["_sqlite3_complete16"] = wasmExports["Gd"];
		Module["_sqlite3_libversion"] = wasmExports["Hd"];
		Module["_sqlite3_libversion_number"] = wasmExports["Id"];
		Module["_sqlite3_threadsafe"] = wasmExports["Jd"];
		Module["_sqlite3_initialize"] = wasmExports["Kd"];
		Module["_sqlite3_shutdown"] = wasmExports["Ld"];
		Module["_sqlite3_config"] = wasmExports["Md"];
		Module["_sqlite3_db_mutex"] = wasmExports["Nd"];
		Module["_sqlite3_db_release_memory"] = wasmExports["Od"];
		Module["_sqlite3_db_cacheflush"] = wasmExports["Pd"];
		Module["_sqlite3_db_config"] = wasmExports["Qd"];
		Module["_sqlite3_last_insert_rowid"] = wasmExports["Rd"];
		Module["_sqlite3_set_last_insert_rowid"] = wasmExports["Sd"];
		Module["_sqlite3_changes64"] = wasmExports["Td"];
		Module["_sqlite3_changes"] = wasmExports["Ud"];
		Module["_sqlite3_total_changes64"] = wasmExports["Vd"];
		Module["_sqlite3_total_changes"] = wasmExports["Wd"];
		Module["_sqlite3_txn_state"] = wasmExports["Xd"];
		Module["_sqlite3_close"] = wasmExports["Yd"];
		Module["_sqlite3_close_v2"] = wasmExports["Zd"];
		Module["_sqlite3_busy_handler"] = wasmExports["_d"];
		Module["_sqlite3_progress_handler"] = wasmExports["$d"];
		Module["_sqlite3_busy_timeout"] = wasmExports["ae"];
		Module["_sqlite3_interrupt"] = wasmExports["be"];
		Module["_sqlite3_is_interrupted"] = wasmExports["ce"];
		Module["_sqlite3_create_function"] = wasmExports["de"];
		Module["_sqlite3_create_function_v2"] = wasmExports["ee"];
		Module["_sqlite3_create_window_function"] = wasmExports["fe"];
		Module["_sqlite3_create_function16"] = wasmExports["ge"];
		Module["_sqlite3_overload_function"] = wasmExports["he"];
		Module["_sqlite3_trace_v2"] = wasmExports["ie"];
		Module["_sqlite3_commit_hook"] = wasmExports["je"];
		Module["_sqlite3_update_hook"] = wasmExports["ke"];
		Module["_sqlite3_rollback_hook"] = wasmExports["le"];
		Module["_sqlite3_autovacuum_pages"] = wasmExports["me"];
		Module["_sqlite3_wal_autocheckpoint"] = wasmExports["ne"];
		Module["_sqlite3_wal_hook"] = wasmExports["oe"];
		Module["_sqlite3_wal_checkpoint_v2"] = wasmExports["pe"];
		Module["_sqlite3_wal_checkpoint"] = wasmExports["qe"];
		Module["_sqlite3_error_offset"] = wasmExports["re"];
		Module["_sqlite3_errmsg16"] = wasmExports["se"];
		Module["_sqlite3_errcode"] = wasmExports["te"];
		Module["_sqlite3_extended_errcode"] = wasmExports["ue"];
		Module["_sqlite3_system_errno"] = wasmExports["ve"];
		Module["_sqlite3_errstr"] = wasmExports["we"];
		Module["_sqlite3_limit"] = wasmExports["xe"];
		Module["_sqlite3_open"] = wasmExports["ye"];
		Module["_sqlite3_open_v2"] = wasmExports["ze"];
		Module["_sqlite3_open16"] = wasmExports["Ae"];
		Module["_sqlite3_create_collation"] = wasmExports["Be"];
		Module["_sqlite3_create_collation_v2"] = wasmExports["Ce"];
		Module["_sqlite3_create_collation16"] = wasmExports["De"];
		Module["_sqlite3_collation_needed"] = wasmExports["Ee"];
		Module["_sqlite3_collation_needed16"] = wasmExports["Fe"];
		Module["_sqlite3_get_clientdata"] = wasmExports["Ge"];
		Module["_sqlite3_set_clientdata"] = wasmExports["He"];
		Module["_sqlite3_get_autocommit"] = wasmExports["Ie"];
		Module["_sqlite3_table_column_metadata"] = wasmExports["Je"];
		Module["_sqlite3_sleep"] = wasmExports["Ke"];
		Module["_sqlite3_extended_result_codes"] = wasmExports["Le"];
		Module["_sqlite3_file_control"] = wasmExports["Me"];
		Module["_sqlite3_test_control"] = wasmExports["Ne"];
		Module["_sqlite3_create_filename"] = wasmExports["Oe"];
		Module["_sqlite3_free_filename"] = wasmExports["Pe"];
		Module["_sqlite3_uri_parameter"] = wasmExports["Qe"];
		Module["_sqlite3_uri_key"] = wasmExports["Re"];
		Module["_sqlite3_uri_boolean"] = wasmExports["Se"];
		Module["_sqlite3_uri_int64"] = wasmExports["Te"];
		Module["_sqlite3_filename_database"] = wasmExports["Ue"];
		Module["_sqlite3_filename_journal"] = wasmExports["Ve"];
		Module["_sqlite3_filename_wal"] = wasmExports["We"];
		Module["_sqlite3_db_name"] = wasmExports["Xe"];
		Module["_sqlite3_db_filename"] = wasmExports["Ye"];
		Module["_sqlite3_db_readonly"] = wasmExports["Ze"];
		Module["_sqlite3_compileoption_used"] = wasmExports["_e"];
		Module["_sqlite3_compileoption_get"] = wasmExports["$e"];
		Module["_sqlite3_sourceid"] = wasmExports["af"];
		Module["_sqlite3mc_config"] = wasmExports["bf"];
		Module["_sqlite3mc_cipher_count"] = wasmExports["cf"];
		Module["_sqlite3mc_cipher_index"] = wasmExports["df"];
		Module["_sqlite3mc_cipher_name"] = wasmExports["ef"];
		Module["_sqlite3mc_config_cipher"] = wasmExports["ff"];
		Module["_sqlite3mc_vfs_create"] = wasmExports["gf"];
		Module["_memcmp"] = wasmExports["hf"];
		_malloc = Module["_malloc"] = wasmExports["jf"];
		_free = Module["_free"] = wasmExports["kf"];
		Module["_memset"] = wasmExports["lf"];
		Module["_RegisterExtensionFunctions"] = wasmExports["nf"];
		Module["_getSqliteFree"] = wasmExports["of"];
		_main = Module["_main"] = wasmExports["pf"];
		Module["_libauthorizer_set_authorizer"] = wasmExports["qf"];
		Module["_libfunction_create_function"] = wasmExports["rf"];
		Module["_libhook_commit_hook"] = wasmExports["sf"];
		Module["_libhook_update_hook"] = wasmExports["tf"];
		Module["_libprogress_progress_handler"] = wasmExports["uf"];
		Module["_libvfs_vfs_register"] = wasmExports["vf"];
		Module["_memcpy"] = wasmExports["wf"];
		_emscripten_builtin_memalign = wasmExports["yf"];
		__emscripten_timeout = wasmExports["zf"];
		__emscripten_tempret_get = wasmExports["Af"];
		...
		dynCalls["iii"] = wasmExports["Ef"];
		dynCalls["iiii"] = wasmExports["Ff"];
		dynCalls["viii"] = wasmExports["Gf"];
		dynCalls["vi"] = wasmExports["Hf"];
		dynCalls["viiiij"] = wasmExports["If"];
		dynCalls["ii"] = wasmExports["Jf"];
		dynCalls["iiiiiii"] = wasmExports["Kf"];
		dynCalls["iiiiii"] = wasmExports["Lf"];
		dynCalls["iiiii"] = wasmExports["Mf"];
		dynCalls["vii"] = wasmExports["Nf"];
		dynCalls["viiii"] = wasmExports["Of"];
		dynCalls["iiiiiiiii"] = wasmExports["Pf"];
		dynCalls["vijii"] = wasmExports["Qf"];
		dynCalls["viiiii"] = wasmExports["Rf"];
		dynCalls["iiiij"] = wasmExports["Sf"];
		dynCalls["viji"] = wasmExports["Tf"];
		dynCalls["iij"] = wasmExports["Uf"];
		dynCalls["iidiiii"] = wasmExports["Vf"];
		dynCalls["iijii"] = wasmExports["Wf"];
		dynCalls["iiji"] = wasmExports["Xf"];
		dynCalls["i"] = wasmExports["Yf"];
		dynCalls["iiiiiij"] = wasmExports["Zf"];
		dynCalls["iiid"] = wasmExports["_f"];
		dynCalls["iiij"] = wasmExports["$f"];
		dynCalls["dii"] = wasmExports["ag"];
		dynCalls["jii"] = wasmExports["bg"];
		dynCalls["ji"] = wasmExports["cg"];
		dynCalls["vid"] = wasmExports["dg"];
		dynCalls["vij"] = wasmExports["eg"];
		dynCalls["iiiiiiiiii"] = wasmExports["fg"];
		dynCalls["di"] = wasmExports["gg"];
		dynCalls["iiiiijii"] = wasmExports["hg"];
		dynCalls["j"] = wasmExports["ig"];
		dynCalls["jj"] = wasmExports["jg"];
		dynCalls["jiij"] = wasmExports["kg"];
		dynCalls["iiiiji"] = wasmExports["lg"];
		dynCalls["iiiijii"] = wasmExports["mg"];
		dynCalls["ij"] = wasmExports["ng"];
		dynCalls["v"] = wasmExports["og"];
		dynCalls["viiji"] = wasmExports["pg"];
		dynCalls["viijii"] = wasmExports["qg"];
		dynCalls["iiiiiiiiiii"] = wasmExports["rg"];
		dynCalls["iiiijji"] = wasmExports["sg"];
		dynCalls["iiiiiiii"] = wasmExports["tg"];
		...
		Module["_sqlite3_version"] = wasmExports["mf"].value;
...
//# sourceMappingURL=mc-wa-sqlite-async-CmHx6OFG.js.map