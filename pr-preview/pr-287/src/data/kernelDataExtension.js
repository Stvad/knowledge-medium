...
import { KERNEL_QUERIES } from "./internals/kernelQueries.js";
import { definitionBlockProjectorFacet, invalidationRulesFacet, mutatorsFacet, postCommitProcessorsFacet, propertySchemasFacet, queriesFacet, sameTxProcessorsFacet, systemPagesFacet, typesFacet } from "./facets.js";
import { KERNEL_TYPE_CONTRIBUTIONS } from "./blockTypes.js";
import { getOrCreatePropertiesPage } from "./propertiesPage.js";
import { getOrCreateTypesPage } from "./typesPage.js";
import { getOrCreateRecentsPage } from "./recentsPage.js";
import { KERNEL_MUTATORS } from "./mutators.js";
import { KERNEL_PROCESSORS } from "./internals/kernelProcessors.js";
import { KERNEL_SAME_TX_PROCESSORS } from "./internals/normalizeReferencesProcessor.js";
import { kernelInvalidationRule } from "./internals/kernelInvalidation.js";
import { userSchemasProjector } from "./userSchemasService.js";
import { userTypesProjector } from "./userTypesService.js";
import { systemToggle } from "../facets/togglable.js";
//#region src/data/kernelDataExtension.ts
/**
...
*/
var kernelDataExtension = systemToggle({
	...
	systemPagesFacet.of({
		id: "kernel:properties",
		ensure: getOrCreatePropertiesPage
	}, { source: "kernel" }),
	systemPagesFacet.of({
		id: "kernel:types",
		ensure: getOrCreateTypesPage
	}, { source: "kernel" }),
	systemPagesFacet.of({
		id: "kernel:recents",
		ensure: getOrCreateRecentsPage
	}, { source: "kernel" }),
...
//#endregion
export { kernelDataExtension };

//# sourceMappingURL=kernelDataExtension.js.map