import { EditorState, Facet, Prec, RangeSet, RangeSetBuilder, StateEffect, StateField, combineConfig, countColumn } from "../../state/dist/index.js";
import { StyleModule } from "../../../style-mod/src/style-mod.js";
import { Decoration, Direction, EditorView, GutterMarker, ViewPlugin, WidgetType, gutter, logException } from "../../view/dist/index.js";
import { IterMode, NodeProp, NodeType, Parser, Tree, TreeFragment } from "../../../@lezer/common/dist/index.js";
import { highlightTree, styleTags, tagHighlighter, tags } from "../../../@lezer/highlight/dist/index.js";
...
//#endregion
export { HighlightStyle, IndentContext, LRLanguage, Language, LanguageDescription, LanguageSupport, ParseContext, bracketMatching, bracketMatchingHandle, continuedIndent, defaultHighlightStyle, defineLanguageFacet, delimitedIndent, flatIndent, foldGutter, foldInside, foldKeymap, foldNodeProp, foldService, getIndentUnit, getIndentation, indentNodeProp, indentOnInput, indentString, indentUnit, languageDataProp, matchBrackets, sublanguageProp, syntaxHighlighting, syntaxTree };
