...
`,Z=`block_types_backfill_v1`,_e=q(Z),ve=J(Z),ye=`
  ...
  WHERE b.deleted = 0 AND typeof(je.value) = 'text'
`,Q=`blocks_fts_backfill_v1`,$=`staging_needs_apply_seeded_v2`,be=q($),xe=J($),Se=q(Q),Ce=J(Q),we=`
