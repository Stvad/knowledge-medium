...
import { AUTO_REFRESH_TICK_DURATION_MS, DEFAULT_HEADERS, EXPIRY_MARGIN_MS, GOTRUE_URL, STORAGE_KEY } from "./lib/constants.js";
...
import { bytesToBase64URL, stringToUint8Array } from "./lib/base64url.js";
import { Deferred, assertPasskeyExperimentalEnabled, decodeJWT, deepClone, generateCallbackId, getAlgorithm, getCodeChallengeAndMethod, getItemAsync, insecureUserWarningProxy, isBrowser, parseParametersFromURL, removeItemAsync, resolveFetch, retryable, setItemAsync, sleep, supportsLocalStorage, userNotAvailableProxy, validateExp } from "./lib/helpers.js";
import { _request, _sessionResponse, _sessionResponsePassword, _ssoResponse, _userResponse } from "./lib/fetch.js";
import GoTrueAdminApi from "./GoTrueAdminApi.js";
import { memoryLocalStorageAdapter } from "./lib/local-storage.js";
import { LockAcquireTimeoutError, navigatorLock } from "./lib/locks.js";
import { polyfillGlobalThis } from "./lib/polyfills.js";
import { createSiweMessage, fromHex, getAddress, toHex } from "./lib/web3/ethereum.js";
import { WebAuthnApi, browserSupportsWebAuthn, createCredential, deserializeCredentialCreationOptions, deserializeCredentialRequestOptions, getCredential, serializeCredentialCreationResponse, serializeCredentialRequestResponse, webAuthnAbortService } from "./lib/webauthn.js";
