//#region src/services/uploadErrorClassifier.ts
var isObjectWith = (value, key) => typeof value === "object" && value !== null && key in value;
...
var PERMANENT_PLPGSQL_SQLSTATES = new Set(["P0002"]);
var isPermanentSqlState = (code) => code.startsWith("22") || code.startsWith("23") || code.startsWith("42") || PERMANENT_PLPGSQL_SQLSTATES.has(code);
...
var PERMANENT_POSTGREST_CODES = new Set([
	"PGRST100",
	"PGRST101",
	"PGRST102",
	"PGRST103",
...
var RECOVERABLE_POSTGREST_CODES = new Set([
	"PGRST301",
	"PGRST302",
	"PGRST202"
]);
...
var RETRYABLE_HTTP_STATUSES = new Set([
	401,
	403,
	408,
	429
]);
var isClientErrorStatus = (status) => status >= 400 && status < 500;
var classifyUploadError = (err) => {
	...
	if (isObjectWith(err, "status") && typeof err.status === "number" && isClientErrorStatus(err.status)) return RETRYABLE_HTTP_STATUSES.has(err.status) ? "transient" : "ambiguous";
	return "transient";
};
//#endregion
export { classifyUploadError };

//# sourceMappingURL=uploadErrorClassifier.js.map