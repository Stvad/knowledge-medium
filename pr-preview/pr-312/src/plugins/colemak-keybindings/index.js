...
import { DATE_SCRUB_CONTEXT, DATE_SCRUB_DAY_BACKWARD_ACTION_ID, DATE_SCRUB_DAY_FORWARD_ACTION_ID, DATE_SCRUB_WEEK_BACKWARD_ACTION_ID, DATE_SCRUB_WEEK_FORWARD_ACTION_ID } from "../daily-notes/dateScrubActions.js";
//#region src/plugins/colemak-keybindings/index.ts
var COLEMAK_KEYBINDINGS_PLUGIN_ID = "system:vim-normal-mode/colemak";
var SOURCE = "colemak-keybindings";
var colemakMovementKeybindingOverrides = [
	{
		actionId: "move_down",
...
var colemakKeybindingsPlugin = systemToggle({
...
}).of(colemakMovementKeybindingOverrides.map((override) => keybindingOverridesFacet.of(override, { source: SOURCE })));
//#endregion
export { COLEMAK_KEYBINDINGS_PLUGIN_ID, colemakKeybindingsPlugin, colemakMovementKeybindingOverrides };
