...
import { getOrInsertCSSRule, getPointProgressOnLine, insertCSSRule, namedNodeMapToObject } from "./utils/element-utils.js";
...
var MediaChromeRange = class extends GlobalThis.HTMLElement {
	...
	attributeChangedCallback(attrName, oldValue, newValue) {
		...
		if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
			...
			if (newValue && this.isConnected) {
				...
				(_e = (_d = __privateGet(this, _mediaController)) == null ? void 0 : _d.associateElement) == null || _e.call(_d, this);
			}
	...
	connectedCallback() {
		...
		__privateGet(this, _cssRules).activeSegment = getOrInsertCSSRule(this.shadowRoot, "#segments-clipping rect:nth-child(0)");
		...
		if (mediaControllerId) {
			...
			(_c = (_b = __privateGet(this, _mediaController)) == null ? void 0 : _b.associateElement) == null || _c.call(_b, this);
		}
		this.updateBar();
	...
	updatePointerBar(evt) {
		var _a;
		(_a = __privateGet(this, _cssRules).pointer) == null || _a.style.setProperty("width", `${this.getPointerRatio(evt) * 100}%`);
	}
	updateBar() {
		var _a, _b;
		const rangePercent = this.range.valueAsNumber * 100;
		(_a = __privateGet(this, _cssRules).progress) == null || _a.style.setProperty("width", `${rangePercent}%`);
		(_b = __privateGet(this, _cssRules).thumb) == null || _b.style.setProperty("left", `${rangePercent}%`);
	}
	...
	getPointerRatio(evt) {
		return getPointProgressOnLine(evt.clientX, evt.clientY, __privateGet(this, _startpoint).getBoundingClientRect(), __privateGet(this, _endpoint).getBoundingClientRect());
	}
	get dragging() {
...
updateActiveSegment_fn = function(evt) {
	...
	const selectorText = `#segments-clipping rect:nth-child(${__privateGet(this, _segments).findIndex((start, i, arr) => {
		const end = arr[i + 1];
...
handlePointerLeave_fn = function() {
	...
	this.toggleAttribute("dragging", false);
	this.range.disabled = this.hasAttribute("disabled");
	(_b = __privateGet(this, _cssRules).activeSegment) == null || _b.style.removeProperty("transform");
};
