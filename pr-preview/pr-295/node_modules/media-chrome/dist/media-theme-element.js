...
var MediaThemeElement = class extends GlobalThis.HTMLElement {
	...
	attributeChangedCallback(attrName, oldValue, newValue) {
		if (attrName === "template" && oldValue != newValue) __privateMethod(this, _updateTemplate, updateTemplate_fn).call(this);
	}
	connectedCallback() {
		this.addEventListener(MediaStateChangeEvents.BREAKPOINTS_COMPUTED, __privateGet(this, _renderBind));
		__privateGet(this, _observer).observe(this, { attributes: true });
	...
	disconnectedCallback() {
		this.removeEventListener(MediaStateChangeEvents.BREAKPOINTS_COMPUTED, __privateGet(this, _renderBind));
...
//#endregion
export { MediaThemeElement };

//# sourceMappingURL=media-theme-element.js.map