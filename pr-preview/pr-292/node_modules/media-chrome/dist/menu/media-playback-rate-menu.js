...
import { getMediaController, getNumericAttr, setNumericAttr } from "../utils/element-utils.js";
...
var MediaPlaybackRateMenu = class extends MediaChromeMenu {
	...
	*/
	set rates(value) {
		if (!value) __privateGet(this, _rates).value = "";
		else if (Array.isArray(value)) __privateGet(this, _rates).value = value.join(" ");
		else if (typeof value === "string") __privateGet(this, _rates).value = value;
		__privateMethod(this, _render, render_fn).call(this);
	}
	/**
...
//# sourceMappingURL=media-playback-rate-menu.js.map