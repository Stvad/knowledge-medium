  ...
  patterns: [
    {
      ...
      example: {
        ...
        code: [
          "import {",
          "  ChangeScope, defineBlockType, definitionSeedsFacet,",
          "  extensionPropertySeedKey, getPluginPrefsBlock, seedProperty, typesFacet,",
    ...
    },
    {
      ...
      example: {
        ...
        code: [
          ...
          "  defineBlockType, definitionSeedsFacet, definePropertyEditorOverride,",
          "  extensionPropertySeedKey, getPluginPrefsBlock, propertyEditorOverridesFacet,",
          "  seedProperty, showPropertiesProp, typesFacet,",
