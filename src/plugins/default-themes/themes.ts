/*
  Built-in palettes contributed via `themesFacet`. The neutral
  `light` / `dark` pair preserves the original shadcn defaults; the
  three named families (`sunset`, `indigo`, `solarized`) give vibrant
  alternates in matching light / dark pairs.

  These are the only places the default palettes live in the
  codebase — src/index.css carries just one of them inlined under
  `:root` as a first-paint fallback (so the page isn't blank before
  the effect injects the rest). Adding or tweaking a default theme
  is a one-spot edit here; the effect handles the rest.
*/
...
const INDIGO_LIGHT: ThemeContribution = {
  id: 'indigo-light',
  label: 'Indigo Light',
  mode: 'light',
  tokens: {
    ...
    primary: '243 75% 59%',
    'primary-foreground': '240 25% 99%',
    secondary: '243 30% 95%',
    'secondary-foreground': '243 60% 25%',
    muted: '240 20% 96%',
...
const INDIGO_DARK: ThemeContribution = {
  id: 'indigo-dark',
  label: 'Indigo Dark',
  mode: 'dark',
  tokens: {
    ...
    secondary: '243 25% 16%',
    'secondary-foreground': '243 30% 90%',
    muted: '240 18% 14%',
    'muted-foreground': '240 12% 65%',
    accent: '270 50% 25%',
    'accent-foreground': '270 80% 92%',
    destructive: '0 62% 45%',
    'destructive-foreground': '0 0% 98%',
    border: '240 20% 18%',
    input: '240 20% 18%',
...
const SOLARIZED_LIGHT: ThemeContribution = {
  id: 'solarized-light',
  label: 'Solarized Light',
  mode: 'light',
  tokens: {
    background: '44 87% 94%',
    foreground: '196 13% 45%',
    card: '44 87% 94%',
    'card-foreground': '196 13% 45%',
    popover: '44 87% 94%',
    'popover-foreground': '196 13% 45%',
    primary: '205 69% 49%',
    'primary-foreground': '44 87% 94%',
    secondary: '46 42% 88%',
    'secondary-foreground': '194 14% 40%',
    muted: '46 42% 88%',
    'muted-foreground': '180 9% 60%',
    accent: '205 50% 90%',
...
const SOLARIZED_DARK: ThemeContribution = {
  ...
  tokens: {
    ...
    secondary: '192 81% 14%',
    'secondary-foreground': '180 9% 60%',
    muted: '192 81% 14%',
    'muted-foreground': '194 14% 40%',
    accent: '200 60% 22%',
    'accent-foreground': '180 9% 60%',
    destructive: '1 71% 52%',
    'destructive-foreground': '44 87% 94%',
    border: '192 60% 18%',
    input: '192 60% 18%',
