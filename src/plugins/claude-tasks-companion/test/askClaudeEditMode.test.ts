...
/**
 * The edit-mode Ask Claude action must work from the LIVE editor doc,
...
import { askClaudeActions, EDIT_MODE_ASK_CLAUDE_ACTION_ID } from '../askClaude.ts'

type EditModeAction = ActionConfig<typeof ActionContextTypes.EDIT_MODE_CM>

const editModeAsk = askClaudeActions.find(a => a.id === EDIT_MODE_ASK_CLAUDE_ACTION_ID) as EditModeAction
