...
export const extensionApiCatalog: ApiModuleGroup[] = [
  ...
  },
  {
    ...
    types: ['Variant', 'VariantFacts', 'VariantRegistration', 'VariantResolver', 'VariantSelection'],
  },
  {
    category: 'facets',
  ...
  // --- Blessed core facets --------------------------------------------------
  {
    ...
    exports: [
      ...
      'appMountsFacet', 'headerItemsFacet', 'panelMountsFacet',
    ],
    types: [
      'AppEffect', 'AppEffectCleanup', 'AppEffectContext', 'AppMountContribution',
      'HeaderItemContribution', 'HeaderItemRegion', 'PanelMountContribution',
    ],
  },
  {
    ...
    exports: [
      ...
      'blockTextClassFacet',
      'blockHeaderFacet', 'blockLayoutFacet', 'blockRendererFacet',
      'shortcutSurfaceActivationsFacet', 'enterBlockEditMode',
    ...
    types: [
      ...
      'BlockContentRendererRegistration', 'BlockContentRendererSlot', 'BlockContentSurfaceContribution',
      'BlockContentSurfaceProps', 'BlockInteractionContext', 'BlockRendererContext',
      'BlockRendererRegistration', 'BlockResolveContext', 'BlockLayout',
      'BlockLayoutRegistration', 'BlockLayoutSlots', 'BlockShellProps', 'ShortcutActivationContribution',
