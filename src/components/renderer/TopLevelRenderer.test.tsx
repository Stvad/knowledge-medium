...
// (fakePanelLayoutProjection.ts): swap the real PanelLayoutProjection for an
// instance-tracking double so this test can assert one gets constructed for
// the root block without touching PowerSync.
