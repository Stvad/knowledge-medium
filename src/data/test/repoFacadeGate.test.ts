...
const SAFE_VIA_PROTOTYPE: Record<string, string> = {
  ...
  hasWriteInFlight: 'getter read (the counter is written by _runAndDispatch on the real repo)',
...
const SAFE_INSTANCE_FIELDS: Record<string, string> = {
  ...
  writesInFlight: 'data field — a counter written only by _runAndDispatch on the real repo',
