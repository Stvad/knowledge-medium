...
import { containsComposedNode, getDocumentOrShadowRoot, namedNodeMapToObject } from "../utils/element-utils.js";
...
var MediaChromeMenuItem = class extends GlobalThis.HTMLElement {
	constructor() {
		...
		*/
		...
		__privateAdd(this, _handleKeyDown, (event) => {
			...
			this.addEventListener("keyup", __privateGet(this, _handleKeyUp), { once: true });
		});
		if (!this.shadowRoot) {
	...
	attributeChangedCallback(attrName, oldValue, newValue) {
		if (attrName === Attributes.CHECKED && isCheckable(this) && !__privateGet(this, _dirty)) this.setAttribute("aria-checked", newValue != null ? "true" : "false");
		else if (attrName === Attributes.TYPE && newValue !== oldValue) this.role = "menuitem" + newValue;
		else if (attrName === Attributes.DISABLED && newValue !== oldValue) if (newValue == null) this.enable();
		else this.disable();
	}
	connectedCallback() {
		if (!this.hasAttribute(Attributes.DISABLED)) this.enable();
		...
		if (this.submenuElement) __privateMethod(this, _submenuConnected, submenuConnected_fn).call(this);
...
handleSlotChange_fn = function(event) {
	...
	if (slot.name === "submenu") if (this.submenuElement) __privateMethod(this, _submenuConnected, submenuConnected_fn).call(this);
	else __privateMethod(this, _submenuDisconnected, submenuDisconnected_fn).call(this);
};
...
//# sourceMappingURL=media-chrome-menu-item.js.map