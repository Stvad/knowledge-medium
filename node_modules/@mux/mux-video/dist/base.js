import { Be, Dn, Gt, J, Ke, Ln, Mt, Ne, Oe, Pn, Qt, Rt, We, Xt, Zt, _n, bt, fr, gt, hn, kn, rt, te, tt } from "../../playback-core/dist/index.js";
import { CustomVideoElement } from "../../../custom-media-element/dist/custom-media-element.js";
...
var t = {
...
}, de = Object.values(t), B = k(), K = "mux-video", T, _, m, I, p, S, O, M, c, R, u, A, N, g, G = class extends CustomVideoElement {
	constructor() {
		super();
		o(this, u);
		o(this, T);
	...
	static get observedAttributes() {
		var e;
		return [...de, ...(e = CustomVideoElement.observedAttributes) != null ? e : []];
	}
	...
	set preferCmcd(e) {
		e !== this.preferCmcd && (e ? fr.includes(e) ? this.setAttribute(t.PREFER_CMCD, e) : console.warn(`Invalid value for preferCmcd. Must be one of ${fr.join()}`) : this.removeAttribute(t.PREFER_CMCD));
	}
	get playerInitTime() {
	...
	get error() {
		var e;
		return (e = Gt(this.nativeEl)) != null ? e : null;
	}
	get errorTranslator() {
		return r(this, M);
	}
	...
	get playbackId() {
		var e;
		return this.hasAttribute(t.PLAYBACK_ID) ? this.getAttribute(t.PLAYBACK_ID) : (e = tt(this.src)) != null ? e : void 0;
	}
	set playbackId(e) {
	...
	get ended() {
		return Xt(this.nativeEl, this._hls);
	}
	get envKey() {
		var e;
	...
	get streamType() {
		var e;
		return (e = this.getAttribute(t.STREAM_TYPE)) != null ? e : Be(this.nativeEl);
	}
	set streamType(e) {
	...
	get chapters() {
		return Mt(this.nativeEl);
	}
	getStartDate() {
		return bt(this.nativeEl, this._hls);
	}
	get currentPdt() {
		return Rt(this.nativeEl, this._hls);
	}
	get preferPlayback() {
	...
	get metadata() {
		return {
			...this.getAttributeNames().filter((i) => i.startsWith("metadata-") && ![t.METADATA_URL].includes(i)).reduce((i, s) => {
	...
	load() {
		Qt(this, this.nativeEl, r(this, u, A));
	}
	unload() {
		Zt(this.nativeEl, r(this, u, A), this);
	}
	attributeChangedCallback(e, i, s) {
		...
		switch (CustomVideoElement.observedAttributes.includes(e) && ![
			...
			case t.DISABLE_COOKIES:
				...
				break;
			case t.CAP_RENDITION_TO_PLAYER_SIZE: (s == null || s !== i) && (this.capRenditionToPlayerSize = s != null ? !0 : void 0);
		}
	}
	updateLogo() {
		...
		if (!e) return;
		e.innerHTML = this.constructor.getLogoHTML(r(this, c) || this.logo);
	}
	connectedCallback() {
		var e, i;
...
T = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakMap(), m = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap(), p = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), c = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), u = /* @__PURE__ */ new WeakSet(), A = function() {
	return _n(this.nativeEl);
}, N = /* @__PURE__ */ new WeakMap(), g = async function() {
