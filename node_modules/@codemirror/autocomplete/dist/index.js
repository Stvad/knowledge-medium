import { Annotation, CharCategory, EditorSelection, Facet, MapMode, Prec, RangeSet, RangeValue, StateEffect, StateField, Text, Transaction, codePointAt, codePointSize, combineConfig, fromCodePoint } from "../../state/dist/index.js";
import { Decoration, Direction, EditorView, ViewPlugin, WidgetType, getTooltip, keymap, logException, showTooltip } from "../../view/dist/index.js";
import { indentUnit, syntaxTree } from "../../language/dist/index.js";
...
//#endregion
export { CompletionContext, acceptCompletion, autocompletion, closeBrackets, closeBracketsKeymap, completeFromList, completionKeymap, completionStatus, ifNotIn, snippetCompletion, startCompletion };
