...
*[Grammar superseded 2026-07: stacks are now bare comma lists (`b1,b2`), parens are reserved for nested sub-layouts, and `(s:` no longer parses — see the video-notes navigation PR (#338) and `src/utils/routing.ts`.]*
